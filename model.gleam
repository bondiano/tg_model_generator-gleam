...
pub type RevenueWithdrawalState {
  RevenueWithdrawalStatePendingRevenueWithdrawalState(RevenueWithdrawalStatePending)
  RevenueWithdrawalStateSucceededRevenueWithdrawalState(RevenueWithdrawalStateSucceeded)
  RevenueWithdrawalStateFailedRevenueWithdrawalState(RevenueWithdrawalStateFailed)
}
...
pub type TransactionPartner {
  ...
  TransactionPartnerAffiliateProgramTransactionPartner(TransactionPartnerAffiliateProgram)
...
pub type PassportElementError {
  PassportElementErrorDataFieldPassportElementError(PassportElementErrorDataField)
  PassportElementErrorFrontSidePassportElementError(PassportElementErrorFrontSide)
  PassportElementErrorReverseSidePassportElementError(PassportElementErrorReverseSide)
  ...
  PassportElementErrorTranslationFilePassportElementError(PassportElementErrorTranslationFile)
  PassportElementErrorTranslationFilesPassportElementError(PassportElementErrorTranslationFiles)
  PassportElementErrorUnspecifiedPassportElementError(PassportElementErrorUnspecified)
}
...
use edited_message <- decode.field("edited_message", decode.optional(message_decoder()))
use channel_post <- decode.field("channel_post", decode.optional(message_decoder()))
use edited_channel_post <- decode.field("edited_channel_post", decode.optional(message_decoder()))
use business_connection <- decode.field("business_connection", decode.optional(business_connection_decoder()))
...
use chosen_inline_result <- decode.field("chosen_inline_result", decode.optional(chosen_inline_result_decoder()))
use callback_query <- decode.field("callback_query", decode.optional(callback_query_decoder()))
use shipping_query <- decode.field("shipping_query", decode.optional(shipping_query_decoder()))
use pre_checkout_query <- decode.field("pre_checkout_query", decode.optional(pre_checkout_query_decoder()))
use purchased_paid_media <- decode.field("purchased_paid_media", decode.optional(paid_media_purchased_decoder()))
use poll <- decode.field("poll", decode.optional(poll_decoder()))
use poll_answer <- decode.field("poll_answer", decode.optional(poll_answer_decoder()))
use my_chat_member <- decode.field("my_chat_member", decode.optional(chat_member_updated_decoder()))
use chat_member <- decode.field("chat_member", decode.optional(chat_member_updated_decoder()))
use chat_join_request <- decode.field("chat_join_request", decode.optional(chat_join_request_decoder()))
use chat_boost <- decode.field("chat_boost", decode.optional(chat_boost_updated_decoder()))
use removed_chat_boost <- decode.field("removed_chat_boost", decode.optional(chat_boost_removed_decoder()))
use managed_bot <- decode.field("managed_bot", decode.optional(managed_bot_updated_decoder()))
...
use has_custom_certificate <- decode.field("has_custom_certificate", decode.bool)
...
use last_error_date <- decode.field("last_error_date", decode.optional(decode.int))
use last_error_message <- decode.field("last_error_message", decode.optional(decode.string))
use last_synchronization_error_date <- decode.field("last_synchronization_error_date", decode.optional(decode.int))
use max_connections <- decode.field("max_connections", decode.optional(decode.int))
use allowed_updates <- decode.field("allowed_updates", decode.optional(decode.list(decode.string)))
...
use language_code <- decode.field("language_code", decode.optional(decode.string))
...
use has_topics_enabled <- decode.field("has_topics_enabled", decode.optional(decode.bool))
use allows_users_to_create_topics <- decode.field("allows_users_to_create_topics", decode.optional(decode.bool))
use can_manage_bots <- decode.field("can_manage_bots", decode.optional(decode.bool))
decode.success(User(
      id: id,
      is_bot: is_bot,
...
use is_direct_messages <- decode.field("is_direct_messages", decode.optional(decode.bool))
decode.success(Chat(
      id: id,
      type_: type_,
      title: title,
...
use active_usernames <- decode.field("active_usernames", decode.optional(decode.list(decode.string)))
use birthdate <- decode.field("birthdate", decode.optional(birthdate_decoder()))
use business_intro <- decode.field("business_intro", decode.optional(business_intro_decoder()))
use business_location <- decode.field("business_location", decode.optional(business_location_decoder()))
use business_opening_hours <- decode.field("business_opening_hours", decode.optional(business_opening_hours_decoder()))
use personal_chat <- decode.field("personal_chat", decode.optional(chat_decoder()))
use parent_chat <- decode.field("parent_chat", decode.optional(chat_decoder()))
use available_reactions <- decode.field("available_reactions", decode.optional(decode.list(reaction_type_decoder())))
use background_custom_emoji_id <- decode.field("background_custom_emoji_id", decode.optional(decode.string))
use profile_accent_color_id <- decode.field("profile_accent_color_id", decode.optional(decode.int))
use profile_background_custom_emoji_id <- decode.field("profile_background_custom_emoji_id", decode.optional(decode.string))
use emoji_status_custom_emoji_id <- decode.field("emoji_status_custom_emoji_id", decode.optional(decode.string))
use emoji_status_expiration_date <- decode.field("emoji_status_expiration_date", decode.optional(decode.int))
use bio <- decode.field("bio", decode.optional(decode.string))
use has_private_forwards <- decode.field("has_private_forwards", decode.optional(decode.bool))
use has_restricted_voice_and_video_messages <- decode.field("has_restricted_voice_and_video_messages", decode.optional(decode.bool))
use join_to_send_messages <- decode.field("join_to_send_messages", decode.optional(decode.bool))
use join_by_request <- decode.field("join_by_request", decode.optional(decode.bool))
use description <- decode.field("description", decode.optional(decode.string))
use invite_link <- decode.field("invite_link", decode.optional(decode.string))
use pinned_message <- decode.field("pinned_message", decode.optional(message_decoder()))
use permissions <- decode.field("permissions", decode.optional(chat_permissions_decoder()))
use accepted_gift_types <- decode.field("accepted_gift_types", accepted_gift_types_decoder())
use can_send_paid_media <- decode.field("can_send_paid_media", decode.optional(decode.bool))
use slow_mode_delay <- decode.field("slow_mode_delay", decode.optional(decode.int))
use unrestrict_boost_count <- decode.field("unrestrict_boost_count", decode.optional(decode.int))
use message_auto_delete_time <- decode.field("message_auto_delete_time", decode.optional(decode.int))
use has_aggressive_anti_spam_enabled <- decode.field("has_aggressive_anti_spam_enabled", decode.optional(decode.bool))
use has_hidden_members <- decode.field("has_hidden_members", decode.optional(decode.bool))
use has_protected_content <- decode.field("has_protected_content", decode.optional(decode.bool))
use has_visible_history <- decode.field("has_visible_history", decode.optional(decode.bool))
use sticker_set_name <- decode.field("sticker_set_name", decode.optional(decode.string))
use can_set_sticker_set <- decode.field("can_set_sticker_set", decode.optional(decode.bool))
use custom_emoji_sticker_set_name <- decode.field("custom_emoji_sticker_set_name", decode.optional(decode.string))
use linked_chat_id <- decode.field("linked_chat_id", decode.optional(decode.int))
use location <- decode.field("location", decode.optional(chat_location_decoder()))
use rating <- decode.field("rating", decode.optional(user_rating_decoder()))
use first_profile_audio <- decode.field("first_profile_audio", decode.optional(audio_decoder()))
use unique_gift_colors <- decode.field("unique_gift_colors", decode.optional(unique_gift_colors_decoder()))
use paid_message_star_count <- decode.field("paid_message_star_count", decode.optional(decode.int))
...
use message_thread_id <- decode.field("message_thread_id", decode.optional(decode.int))
use direct_messages_topic <- decode.field("direct_messages_topic", decode.optional(direct_messages_topic_decoder()))
use from <- decode.field("from", decode.optional(user_decoder()))
use sender_chat <- decode.field("sender_chat", decode.optional(chat_decoder()))
use sender_boost_count <- decode.field("sender_boost_count", decode.optional(decode.int))
...
use is_topic_message <- decode.field("is_topic_message", decode.optional(decode.bool))
use is_automatic_forward <- decode.field("is_automatic_forward", decode.optional(decode.bool))
use reply_to_message <- decode.field("reply_to_message", decode.optional(message_decoder()))
use external_reply <- decode.field("external_reply", decode.optional(external_reply_info_decoder()))
use quote <- decode.field("quote", decode.optional(text_quote_decoder()))
use reply_to_story <- decode.field("reply_to_story", decode.optional(story_decoder()))
...
use media_group_id <- decode.field("media_group_id", decode.optional(decode.string))
use author_signature <- decode.field("author_signature", decode.optional(decode.string))
use paid_star_count <- decode.field("paid_star_count", decode.optional(decode.int))
use text <- decode.field("text", decode.optional(decode.string))
use entities <- decode.field("entities", decode.optional(decode.list(message_entity_decoder())))
use link_preview_options <- decode.field("link_preview_options", decode.optional(link_preview_options_decoder()))
use suggested_post_info <- decode.field("suggested_post_info", decode.optional(suggested_post_info_decoder()))
...
use video_note <- decode.field("video_note", decode.optional(video_note_decoder()))
...
use has_media_spoiler <- decode.field("has_media_spoiler", decode.optional(decode.bool))
use checklist <- decode.field("checklist", decode.optional(checklist_decoder()))
...
use new_chat_members <- decode.field("new_chat_members", decode.optional(decode.list(user_decoder())))
use left_chat_member <- decode.field("left_chat_member", decode.optional(user_decoder()))
use chat_owner_left <- decode.field("chat_owner_left", decode.optional(chat_owner_left_decoder()))
use chat_owner_changed <- decode.field("chat_owner_changed", decode.optional(chat_owner_changed_decoder()))
use new_chat_title <- decode.field("new_chat_title", decode.optional(decode.string))
use new_chat_photo <- decode.field("new_chat_photo", decode.optional(decode.list(photo_size_decoder())))
use delete_chat_photo <- decode.field("delete_chat_photo", decode.optional(decode.bool))
use group_chat_created <- decode.field("group_chat_created", decode.optional(decode.bool))
use supergroup_chat_created <- decode.field("supergroup_chat_created", decode.optional(decode.bool))
use channel_chat_created <- decode.field("channel_chat_created", decode.optional(decode.bool))
use message_auto_delete_timer_changed <- decode.field("message_auto_delete_timer_changed", decode.optional(message_auto_delete_timer_changed_decoder()))
use migrate_to_chat_id <- decode.field("migrate_to_chat_id", decode.optional(decode.int))
use migrate_from_chat_id <- decode.field("migrate_from_chat_id", decode.optional(decode.int))
use pinned_message <- decode.field("pinned_message", decode.optional(maybe_inaccessible_message_decoder()))
use invoice <- decode.field("invoice", decode.optional(invoice_decoder()))
use successful_payment <- decode.field("successful_payment", decode.optional(successful_payment_decoder()))
use refunded_payment <- decode.field("refunded_payment", decode.optional(refunded_payment_decoder()))
use users_shared <- decode.field("users_shared", decode.optional(users_shared_decoder()))
use chat_shared <- decode.field("chat_shared", decode.optional(chat_shared_decoder()))
use gift <- decode.field("gift", decode.optional(gift_info_decoder()))
use unique_gift <- decode.field("unique_gift", decode.optional(unique_gift_info_decoder()))
use gift_upgrade_sent <- decode.field("gift_upgrade_sent", decode.optional(gift_info_decoder()))
use connected_website <- decode.field("connected_website", decode.optional(decode.string))
use write_access_allowed <- decode.field("write_access_allowed", decode.optional(write_access_allowed_decoder()))
use passport_data <- decode.field("passport_data", decode.optional(passport_data_decoder()))
use proximity_alert_triggered <- decode.field("proximity_alert_triggered", decode.optional(proximity_alert_triggered_decoder()))
use boost_added <- decode.field("boost_added", decode.optional(chat_boost_added_decoder()))
use chat_background_set <- decode.field("chat_background_set", decode.optional(chat_background_decoder()))
use checklist_tasks_done <- decode.field("checklist_tasks_done", decode.optional(checklist_tasks_done_decoder()))
use checklist_tasks_added <- decode.field("checklist_tasks_added", decode.optional(checklist_tasks_added_decoder()))
use direct_message_price_changed <- decode.field("direct_message_price_changed", decode.optional(direct_message_price_changed_decoder()))
use forum_topic_created <- decode.field("forum_topic_created", decode.optional(forum_topic_created_decoder()))
use forum_topic_edited <- decode.field("forum_topic_edited", decode.optional(forum_topic_edited_decoder()))
use forum_topic_closed <- decode.field("forum_topic_closed", decode.optional(forum_topic_closed_decoder()))
use forum_topic_reopened <- decode.field("forum_topic_reopened", decode.optional(forum_topic_reopened_decoder()))
use general_forum_topic_hidden <- decode.field("general_forum_topic_hidden", decode.optional(general_forum_topic_hidden_decoder()))
use general_forum_topic_unhidden <- decode.field("general_forum_topic_unhidden", decode.optional(general_forum_topic_unhidden_decoder()))
use giveaway_created <- decode.field("giveaway_created", decode.optional(giveaway_created_decoder()))
use giveaway <- decode.field("giveaway", decode.optional(giveaway_decoder()))
use giveaway_winners <- decode.field("giveaway_winners", decode.optional(giveaway_winners_decoder()))
use giveaway_completed <- decode.field("giveaway_completed", decode.optional(giveaway_completed_decoder()))
use managed_bot_created <- decode.field("managed_bot_created", decode.optional(managed_bot_created_decoder()))
use paid_message_price_changed <- decode.field("paid_message_price_changed", decode.optional(paid_message_price_changed_decoder()))
use poll_option_added <- decode.field("poll_option_added", decode.optional(poll_option_added_decoder()))
use poll_option_deleted <- decode.field("poll_option_deleted", decode.optional(poll_option_deleted_decoder()))
use suggested_post_approved <- decode.field("suggested_post_approved", decode.optional(suggested_post_approved_decoder()))
use suggested_post_approval_failed <- decode.field("suggested_post_approval_failed", decode.optional(suggested_post_approval_failed_decoder()))
use suggested_post_declined <- decode.field("suggested_post_declined", decode.optional(suggested_post_declined_decoder()))
use suggested_post_paid <- decode.field("suggested_post_paid", decode.optional(suggested_post_paid_decoder()))
use suggested_post_refunded <- decode.field("suggested_post_refunded", decode.optional(suggested_post_refunded_decoder()))
use video_chat_scheduled <- decode.field("video_chat_scheduled", decode.optional(video_chat_scheduled_decoder()))
use video_chat_started <- decode.field("video_chat_started", decode.optional(video_chat_started_decoder()))
use video_chat_ended <- decode.field("video_chat_ended", decode.optional(video_chat_ended_decoder()))
use video_chat_participants_invited <- decode.field("video_chat_participants_invited", decode.optional(video_chat_participants_invited_decoder()))
use web_app_data <- decode.field("web_app_data", decode.optional(web_app_data_decoder()))
use reply_markup <- decode.field("reply_markup", decode.optional(inline_keyboard_markup_decoder()))
...
use custom_emoji_id <- decode.field("custom_emoji_id", decode.optional(decode.string))
use unix_time <- decode.field("unix_time", decode.optional(decode.int))
use date_time_format <- decode.field("date_time_format", decode.optional(decode.string))
...
use message_id <- decode.field("message_id", decode.int)
use chat_id <- decode.field("chat_id", decode.optional(int_or_string_decoder()))
use allow_sending_without_reply <- decode.field("allow_sending_without_reply", decode.optional(decode.bool))
use quote <- decode.field("quote", decode.optional(decode.string))
use quote_parse_mode <- decode.field("quote_parse_mode", decode.optional(decode.string))
use quote_entities <- decode.field("quote_entities", decode.optional(decode.list(message_entity_decoder())))
use quote_position <- decode.field("quote_position", decode.optional(decode.int))
use checklist_task_id <- decode.field("checklist_task_id", decode.optional(decode.int))
use poll_option_id <- decode.field("poll_option_id", decode.optional(decode.string))
...
pub fn message_origin_hidden_user_decoder() -> decode.Decoder(MessageOriginHiddenUser) {
use type_ <- decode.field("type_", decode.string)
use date <- decode.field("date", decode.int)
...
use thumbnail <- decode.field("thumbnail", decode.optional(photo_size_decoder()))
...
use duration <- decode.field("duration", decode.int)
use thumbnail <- decode.field("thumbnail", decode.optional(photo_size_decoder()))
use cover <- decode.field("cover", decode.optional(decode.list(photo_size_decoder())))
use start_timestamp <- decode.field("start_timestamp", decode.optional(decode.int))
use qualities <- decode.field("qualities", decode.optional(decode.list(video_quality_decoder())))
use file_name <- decode.field("file_name", decode.optional(decode.string))
use mime_type <- decode.field("mime_type", decode.optional(decode.string))
use file_size <- decode.field("file_size", decode.optional(decode.int))
...
use paid_media <- decode.field("paid_media", decode.list(paid_media_decoder()))
decode.success(PaidMediaInfo(
...
use option_persistent_ids <- decode.field("option_persistent_ids", decode.list(decode.string))
...
use question_entities <- decode.field("question_entities", decode.optional(decode.list(message_entity_decoder())))
...
use text <- decode.field("text", decode.string)
use text_entities <- decode.field("text_entities", decode.optional(decode.list(message_entity_decoder())))
use completed_by_user <- decode.field("completed_by_user", decode.optional(user_decoder()))
use completed_by_chat <- decode.field("completed_by_chat", decode.optional(chat_decoder()))
use completion_date <- decode.field("completion_date", decode.optional(decode.int))
...
use title_entities <- decode.field("title_entities", decode.optional(decode.list(message_entity_decoder())))
use tasks <- decode.field("tasks", decode.list(checklist_task_decoder()))
use others_can_add_tasks <- decode.field("others_can_add_tasks", decode.optional(decode.bool))
use others_can_mark_tasks_as_done <- decode.field("others_can_mark_tasks_as_done", decode.optional(decode.bool))
...
use parse_mode <- decode.field("parse_mode", decode.optional(decode.string))
use title_entities <- decode.field("title_entities", decode.optional(decode.list(message_entity_decoder())))
use tasks <- decode.field("tasks", decode.list(input_checklist_task_decoder()))
use others_can_add_tasks <- decode.field("others_can_add_tasks", decode.optional(decode.bool))
use others_can_mark_tasks_as_done <- decode.field("others_can_mark_tasks_as_done", decode.optional(decode.bool))
...
use checklist_message <- decode.field("checklist_message", decode.optional(message_decoder()))
use marked_as_done_task_ids <- decode.field("marked_as_done_task_ids", decode.optional(decode.list(decode.int)))
use marked_as_not_done_task_ids <- decode.field("marked_as_not_done_task_ids", decode.optional(decode.list(decode.int)))
...
use proximity_alert_radius <- decode.field("proximity_alert_radius", decode.optional(decode.int))
...
decode.success(WebAppData(
      data: data,
      button_text: button_text))
}

pub fn proximity_alert_triggered_decoder() -> decode.Decoder(ProximityAlertTriggered) {
...
pub fn message_auto_delete_timer_changed_decoder() -> decode.Decoder(MessageAutoDeleteTimerChanged) {
use message_auto_delete_time <- decode.field("message_auto_delete_time", decode.int)
...
decode.success(ManagedBotCreated(
      bot: bot))
}
...
use bot <- decode.field("bot", user_decoder())
decode.success(ManagedBotUpdated(
      user: user,
      bot: bot))
}

pub fn poll_option_added_decoder() -> decode.Decoder(PollOptionAdded) {
use poll_message <- decode.field("poll_message", decode.optional(maybe_inaccessible_message_decoder()))
use option_persistent_id <- decode.field("option_persistent_id", decode.string)
use option_text <- decode.field("option_text", decode.string)
use option_text_entities <- decode.field("option_text_entities", decode.optional(decode.list(message_entity_decoder())))
...
decode.success(BackgroundFillSolid(
      type_: type_,
      color: color))
}

pub fn background_fill_gradient_decoder() -> decode.Decoder(BackgroundFillGradient) {
use type_ <- decode.field("type_", decode.string)
...
pub fn background_fill_freeform_gradient_decoder() -> decode.Decoder(BackgroundFillFreeformGradient) {
use type_ <- decode.field("type_", decode.string)
...
pub fn background_type_wallpaper_decoder() -> decode.Decoder(BackgroundTypeWallpaper) {
use type_ <- decode.field("type_", decode.string)
...
pub fn background_type_pattern_decoder() -> decode.Decoder(BackgroundTypePattern) {
use type_ <- decode.field("type_", decode.string)
use document <- decode.field("document", document_decoder())
use fill <- decode.field("fill", background_fill_decoder())
...
pub fn background_type_chat_theme_decoder() -> decode.Decoder(BackgroundTypeChatTheme) {
use type_ <- decode.field("type_", decode.string)
use theme_name <- decode.field("theme_name", decode.string)
decode.success(BackgroundTypeChatTheme(
      type_: type_,
...
use icon_custom_emoji_id <- decode.field("icon_custom_emoji_id", decode.optional(decode.string))
use is_name_implicit <- decode.field("is_name_implicit", decode.optional(decode.bool))
...
pub fn general_forum_topic_hidden_decoder() -> decode.Decoder(GeneralForumTopicHidden) {

decode.success(GeneralForumTopicHidden)
}

pub fn general_forum_topic_unhidden_decoder() -> decode.Decoder(GeneralForumTopicUnhidden) {
...
use web_app_name <- decode.field("web_app_name", decode.optional(decode.string))
use from_attachment_menu <- decode.field("from_attachment_menu", decode.optional(decode.bool))
...
decode.success(VideoChatScheduled(
...
use duration <- decode.field("duration", decode.int)
decode.success(VideoChatEnded(
      duration: duration))
}

pub fn video_chat_participants_invited_decoder() -> decode.Decoder(VideoChatParticipantsInvited) {
use users <- decode.field("users", decode.list(user_decoder()))
decode.success(VideoChatParticipantsInvited(
      users: users))
}

pub fn paid_message_price_changed_decoder() -> decode.Decoder(PaidMessagePriceChanged) {
use paid_message_star_count <- decode.field("paid_message_star_count", decode.int)
decode.success(PaidMessagePriceChanged(
      paid_message_star_count: paid_message_star_count))
}

pub fn direct_message_price_changed_decoder() -> decode.Decoder(DirectMessagePriceChanged) {
use are_direct_messages_enabled <- decode.field("are_direct_messages_enabled", decode.bool)
use direct_message_star_count <- decode.field("direct_message_star_count", decode.optional(decode.int))
...
pub fn suggested_post_approved_decoder() -> decode.Decoder(SuggestedPostApproved) {
use suggested_post_message <- decode.field("suggested_post_message", decode.optional(message_decoder()))
use price <- decode.field("price", decode.optional(suggested_post_price_decoder()))
...
pub fn suggested_post_approval_failed_decoder() -> decode.Decoder(SuggestedPostApprovalFailed) {
use suggested_post_message <- decode.field("suggested_post_message", decode.optional(message_decoder()))
...
pub fn suggested_post_declined_decoder() -> decode.Decoder(SuggestedPostDeclined) {
use suggested_post_message <- decode.field("suggested_post_message", decode.optional(message_decoder()))
...
use star_amount <- decode.field("star_amount", decode.optional(star_amount_decoder()))
...
pub fn suggested_post_refunded_decoder() -> decode.Decoder(SuggestedPostRefunded) {
use suggested_post_message <- decode.field("suggested_post_message", decode.optional(message_decoder()))
...
use prize_star_count <- decode.field("prize_star_count", decode.optional(decode.int))
decode.success(GiveawayCreated(
...
use winners_selection_date <- decode.field("winners_selection_date", decode.int)
use winner_count <- decode.field("winner_count", decode.int)
use only_new_members <- decode.field("only_new_members", decode.optional(decode.bool))
use has_public_winners <- decode.field("has_public_winners", decode.optional(decode.bool))
use prize_description <- decode.field("prize_description", decode.optional(decode.string))
use country_codes <- decode.field("country_codes", decode.optional(decode.list(decode.string)))
use prize_star_count <- decode.field("prize_star_count", decode.optional(decode.int))
use premium_subscription_month_count <- decode.field("premium_subscription_month_count", decode.optional(decode.int))
...
use additional_chat_count <- decode.field("additional_chat_count", decode.optional(decode.int))
use prize_star_count <- decode.field("prize_star_count", decode.optional(decode.int))
use premium_subscription_month_count <- decode.field("premium_subscription_month_count", decode.optional(decode.int))
use unclaimed_prize_count <- decode.field("unclaimed_prize_count", decode.optional(decode.int))
use only_new_members <- decode.field("only_new_members", decode.optional(decode.bool))
...
use winner_count <- decode.field("winner_count", decode.int)
use unclaimed_prize_count <- decode.field("unclaimed_prize_count", decode.optional(decode.int))
use giveaway_message <- decode.field("giveaway_message", decode.optional(message_decoder()))
use is_star_giveaway <- decode.field("is_star_giveaway", decode.optional(decode.bool))
...
use url <- decode.field("url", decode.optional(decode.string))
use prefer_small_media <- decode.field("prefer_small_media", decode.optional(decode.bool))
use prefer_large_media <- decode.field("prefer_large_media", decode.optional(decode.bool))
use show_above_text <- decode.field("show_above_text", decode.optional(decode.bool))
...
decode.success(SuggestedPostPrice(
      currency: currency,
      amount: amount))
}
...
pub fn suggested_post_parameters_decoder() -> decode.Decoder(SuggestedPostParameters) {
use price <- decode.field("price", decode.optional(suggested_post_price_decoder()))
use send_date <- decode.field("send_date", decode.optional(decode.int))
decode.success(SuggestedPostParameters(
      price: price,
      send_date: send_date))
}
...
use user <- decode.field("user", decode.optional(user_decoder()))
decode.success(DirectMessagesTopic(
      topic_id: topic_id,
      user: user))
}
...
use photos <- decode.field("photos", decode.list(decode.list(photo_size_decoder())))
decode.success(UserProfilePhotos(
...
decode.success(UserProfileAudios(
      total_count: total_count,
      audios: audios))
}
...
use url <- decode.field("url", decode.string)
decode.success(WebAppInfo(
      url: url))
}

pub fn reply_keyboard_markup_decoder() -> decode.Decoder(ReplyKeyboardMarkup) {
use keyboard <- decode.field("keyboard", decode.list(decode.list(keyboard_button_decoder())))
use is_persistent <- decode.field("is_persistent", decode.optional(decode.bool))
use resize_keyboard <- decode.field("resize_keyboard", decode.optional(decode.bool))
use one_time_keyboard <- decode.field("one_time_keyboard", decode.optional(decode.bool))
use input_field_placeholder <- decode.field("input_field_placeholder", decode.optional(decode.string))
...
use request_users <- decode.field("request_users", decode.optional(keyboard_button_request_users_decoder()))
use request_chat <- decode.field("request_chat", decode.optional(keyboard_button_request_chat_decoder()))
use request_managed_bot <- decode.field("request_managed_bot", decode.optional(keyboard_button_request_managed_bot_decoder()))
use request_contact <- decode.field("request_contact", decode.optional(decode.bool))
use request_location <- decode.field("request_location", decode.optional(decode.bool))
use request_poll <- decode.field("request_poll", decode.optional(keyboard_button_poll_type_decoder()))
use web_app <- decode.field("web_app", decode.optional(web_app_info_decoder()))
...
pub fn keyboard_button_request_users_decoder() -> decode.Decoder(KeyboardButtonRequestUsers) {
use request_id <- decode.field("request_id", decode.int)
use user_is_bot <- decode.field("user_is_bot", decode.optional(decode.bool))
use user_is_premium <- decode.field("user_is_premium", decode.optional(decode.bool))
...
use request_username <- decode.field("request_username", decode.optional(decode.bool))
use request_photo <- decode.field("request_photo", decode.optional(decode.bool))
...
pub fn keyboard_button_request_chat_decoder() -> decode.Decoder(KeyboardButtonRequestChat) {
use request_id <- decode.field("request_id", decode.int)
use chat_is_channel <- decode.field("chat_is_channel", decode.bool)
use chat_is_forum <- decode.field("chat_is_forum", decode.optional(decode.bool))
use chat_has_username <- decode.field("chat_has_username", decode.optional(decode.bool))
use chat_is_created <- decode.field("chat_is_created", decode.optional(decode.bool))
use user_administrator_rights <- decode.field("user_administrator_rights", decode.optional(chat_administrator_rights_decoder()))
use bot_administrator_rights <- decode.field("bot_administrator_rights", decode.optional(chat_administrator_rights_decoder()))
use bot_is_member <- decode.field("bot_is_member", decode.optional(decode.bool))
use request_title <- decode.field("request_title", decode.optional(decode.bool))
use request_username <- decode.field("request_username", decode.optional(decode.bool))
use request_photo <- decode.field("request_photo", decode.optional(decode.bool))
...
pub fn keyboard_button_request_managed_bot_decoder() -> decode.Decoder(KeyboardButtonRequestManagedBot) {
use request_id <- decode.field("request_id", decode.int)
use suggested_name <- decode.field("suggested_name", decode.optional(decode.string))
use suggested_username <- decode.field("suggested_username", decode.optional(decode.string))
...
pub fn keyboard_button_poll_type_decoder() -> decode.Decoder(KeyboardButtonPollType) {
use type_ <- decode.field("type_", decode.optional(decode.string))
decode.success(KeyboardButtonPollType(
      type_: type_))
}
...
use inline_keyboard <- decode.field("inline_keyboard", decode.list(decode.list(inline_keyboard_button_decoder())))
...
use style <- decode.field("style", decode.optional(decode.string))
use url <- decode.field("url", decode.optional(decode.string))
use callback_data <- decode.field("callback_data", decode.optional(decode.string))
use web_app <- decode.field("web_app", decode.optional(web_app_info_decoder()))
use login_url <- decode.field("login_url", decode.optional(login_url_decoder()))
use switch_inline_query <- decode.field("switch_inline_query", decode.optional(decode.string))
use switch_inline_query_current_chat <- decode.field("switch_inline_query_current_chat", decode.optional(decode.string))
use switch_inline_query_chosen_chat <- decode.field("switch_inline_query_chosen_chat", decode.optional(switch_inline_query_chosen_chat_decoder()))
use copy_text <- decode.field("copy_text", decode.optional(copy_text_button_decoder()))
use callback_game <- decode.field("callback_game", decode.optional(callback_game_decoder()))
...
use url <- decode.field("url", decode.string)
use forward_text <- decode.field("forward_text", decode.optional(decode.string))
use bot_username <- decode.field("bot_username", decode.optional(decode.string))
use request_write_access <- decode.field("request_write_access", decode.optional(decode.bool))
...
pub fn switch_inline_query_chosen_chat_decoder() -> decode.Decoder(SwitchInlineQueryChosenChat) {
use query <- decode.field("query", decode.optional(decode.string))
use allow_user_chats <- decode.field("allow_user_chats", decode.optional(decode.bool))
use allow_bot_chats <- decode.field("allow_bot_chats", decode.optional(decode.bool))
use allow_group_chats <- decode.field("allow_group_chats", decode.optional(decode.bool))
use allow_channel_chats <- decode.field("allow_channel_chats", decode.optional(decode.bool))
...
use message <- decode.field("message", decode.optional(maybe_inaccessible_message_decoder()))
use inline_message_id <- decode.field("inline_message_id", decode.optional(decode.string))
use chat_instance <- decode.field("chat_instance", decode.string)
use data <- decode.field("data", decode.optional(decode.string))
use game_short_name <- decode.field("game_short_name", decode.optional(decode.string))
...
use small_file_unique_id <- decode.field("small_file_unique_id", decode.string)
...
use pending_join_request_count <- decode.field("pending_join_request_count", decode.optional(decode.int))
use subscription_period <- decode.field("subscription_period", decode.optional(decode.int))
use subscription_price <- decode.field("subscription_price", decode.optional(decode.int))
...
pub fn chat_administrator_rights_decoder() -> decode.Decoder(ChatAdministratorRights) {
use is_anonymous <- decode.field("is_anonymous", decode.bool)
...
use can_manage_video_chats <- decode.field("can_manage_video_chats", decode.bool)
...
use can_post_messages <- decode.field("can_post_messages", decode.optional(decode.bool))
use can_edit_messages <- decode.field("can_edit_messages", decode.optional(decode.bool))
use can_pin_messages <- decode.field("can_pin_messages", decode.optional(decode.bool))
use can_manage_topics <- decode.field("can_manage_topics", decode.optional(decode.bool))
use can_manage_direct_messages <- decode.field("can_manage_direct_messages", decode.optional(decode.bool))
use can_manage_tags <- decode.field("can_manage_tags", decode.optional(decode.bool))
...
use invite_link <- decode.field("invite_link", decode.optional(chat_invite_link_decoder()))
use via_join_request <- decode.field("via_join_request", decode.optional(decode.bool))
use via_chat_folder_invite_link <- decode.field("via_chat_folder_invite_link", decode.optional(decode.bool))
...
use user <- decode.field("user", user_decoder())
use is_anonymous <- decode.field("is_anonymous", decode.bool)
use custom_title <- decode.field("custom_title", decode.optional(decode.string))
...
pub fn chat_member_administrator_decoder() -> decode.Decoder(ChatMemberAdministrator) {
use status <- decode.field("status", decode.string)
use user <- decode.field("user", user_decoder())
...
use can_send_messages <- decode.field("can_send_messages", decode.optional(decode.bool))
use can_send_audios <- decode.field("can_send_audios", decode.optional(decode.bool))
use can_send_documents <- decode.field("can_send_documents", decode.optional(decode.bool))
use can_send_photos <- decode.field("can_send_photos", decode.optional(decode.bool))
use can_send_videos <- decode.field("can_send_videos", decode.optional(decode.bool))
use can_send_video_notes <- decode.field("can_send_video_notes", decode.optional(decode.bool))
use can_send_voice_notes <- decode.field("can_send_voice_notes", decode.optional(decode.bool))
...
use address <- decode.field("address", decode.string)
use location <- decode.field("location", decode.optional(location_decoder()))
decode.success(BusinessLocation(
      address: address,
      location: location))
}

pub fn business_opening_hours_interval_decoder() -> decode.Decoder(BusinessOpeningHoursInterval) {
...
use opening_hours <- decode.field("opening_hours", decode.list(business_opening_hours_interval_decoder()))
...
use next_level_rating <- decode.field("next_level_rating", decode.optional(decode.int))
...
use corner_radius_percentage <- decode.field("corner_radius_percentage", decode.float)
...
use latitude <- decode.field("latitude", decode.float)
use longitude <- decode.field("longitude", decode.float)
use address <- decode.field("address", decode.optional(location_address_decoder()))
...
pub fn story_area_type_location_decoder() -> decode.Decoder(StoryAreaTypeLocation) {
use type_ <- decode.field("type_", decode.string)
use latitude <- decode.field("latitude", decode.float)
use longitude <- decode.field("longitude", decode.float)
use address <- decode.field("address", decode.optional(location_address_decoder()))
...
pub fn story_area_type_suggested_reaction_decoder() -> decode.Decoder(StoryAreaTypeSuggestedReaction) {
use type_ <- decode.field("type_", decode.string)
...
use type_ <- decode.field("type_", decode.string)
use url <- decode.field("url", decode.string)
decode.success(StoryAreaTypeLink(
      type_: type_,
      url: url))
}
...
pub fn story_area_type_unique_gift_decoder() -> decode.Decoder(StoryAreaTypeUniqueGift) {
use type_ <- decode.field("type_", decode.string)
use name <- decode.field("name", decode.string)
decode.success(StoryAreaTypeUniqueGift(
      type_: type_,
      name: name))
}
...
use type_ <- decode.field("type_", decode.string)
use emoji <- decode.field("emoji", decode.string)
decode.success(ReactionTypeEmoji(
      type_: type_,
      emoji: emoji))
}

pub fn reaction_type_custom_emoji_decoder() -> decode.Decoder(ReactionTypeCustomEmoji) {
use type_ <- decode.field("type_", decode.string)
...
use type_ <- decode.field("type_", decode.string)
decode.success(ReactionTypePaid(
      type_: type_))
}
...
use total_count <- decode.field("total_count", decode.int)
decode.success(ReactionCount(
      type_: type_,
      total_count: total_count))
}

pub fn message_reaction_updated_decoder() -> decode.Decoder(MessageReactionUpdated) {
use chat <- decode.field("chat", chat_decoder())
use message_id <- decode.field("message_id", decode.int)
use user <- decode.field("user", decode.optional(user_decoder()))
use actor_chat <- decode.field("actor_chat", decode.optional(chat_decoder()))
use date <- decode.field("date", decode.int)
use old_reaction <- decode.field("old_reaction", decode.list(reaction_type_decoder()))
use new_reaction <- decode.field("new_reaction", decode.list(reaction_type_decoder()))
...
pub fn message_reaction_count_updated_decoder() -> decode.Decoder(MessageReactionCountUpdated) {
use chat <- decode.field("chat", chat_decoder())
use message_id <- decode.field("message_id", decode.int)
use date <- decode.field("date", decode.int)
use reactions <- decode.field("reactions", decode.list(reaction_count_decoder()))
...
use star_count <- decode.field("star_count", decode.int)
use upgrade_star_count <- decode.field("upgrade_star_count", decode.optional(decode.int))
use is_premium <- decode.field("is_premium", decode.optional(decode.bool))
...
use remaining_count <- decode.field("remaining_count", decode.optional(decode.int))
use personal_total_count <- decode.field("personal_total_count", decode.optional(decode.int))
use personal_remaining_count <- decode.field("personal_remaining_count", decode.optional(decode.int))
use background <- decode.field("background", decode.optional(gift_background_decoder()))
use unique_gift_variant_count <- decode.field("unique_gift_variant_count", decode.optional(decode.int))
use publisher_chat <- decode.field("publisher_chat", decode.optional(chat_decoder()))
decode.success(Gift(
      id: id,
      sticker: sticker,
      star_count: star_count,
...
pub fn unique_gift_backdrop_colors_decoder() -> decode.Decoder(UniqueGiftBackdropColors) {
use center_color <- decode.field("center_color", decode.int)
use edge_color <- decode.field("edge_color", decode.int)
...
use model_custom_emoji_id <- decode.field("model_custom_emoji_id", decode.string)
use symbol_custom_emoji_id <- decode.field("symbol_custom_emoji_id", decode.string)
use light_theme_main_color <- decode.field("light_theme_main_color", decode.int)
use light_theme_other_colors <- decode.field("light_theme_other_colors", decode.list(decode.int))
use dark_theme_main_color <- decode.field("dark_theme_main_color", decode.int)
use dark_theme_other_colors <- decode.field("dark_theme_other_colors", decode.list(decode.int))
...
use is_from_blockchain <- decode.field("is_from_blockchain", decode.optional(decode.bool))
use colors <- decode.field("colors", decode.optional(unique_gift_colors_decoder()))
use publisher_chat <- decode.field("publisher_chat", decode.optional(chat_decoder()))
...
use owned_gift_id <- decode.field("owned_gift_id", decode.optional(decode.string))
use convert_star_count <- decode.field("convert_star_count", decode.optional(decode.int))
use prepaid_upgrade_star_count <- decode.field("prepaid_upgrade_star_count", decode.optional(decode.int))
use is_upgrade_separate <- decode.field("is_upgrade_separate", decode.optional(decode.bool))
use can_be_upgraded <- decode.field("can_be_upgraded", decode.optional(decode.bool))
use text <- decode.field("text", decode.optional(decode.string))
use entities <- decode.field("entities", decode.optional(decode.list(message_entity_decoder())))
use is_private <- decode.field("is_private", decode.optional(decode.bool))
use unique_gift_number <- decode.field("unique_gift_number", decode.optional(decode.int))
...
use last_resale_currency <- decode.field("last_resale_currency", decode.optional(decode.string))
use last_resale_amount <- decode.field("last_resale_amount", decode.optional(decode.int))
use owned_gift_id <- decode.field("owned_gift_id", decode.optional(decode.string))
use transfer_star_count <- decode.field("transfer_star_count", decode.optional(decode.int))
use next_transfer_date <- decode.field("next_transfer_date", decode.optional(decode.int))
...
use gift <- decode.field("gift", gift_decoder())
use owned_gift_id <- decode.field("owned_gift_id", decode.optional(decode.string))
use sender_user <- decode.field("sender_user", decode.optional(user_decoder()))
use send_date <- decode.field("send_date", decode.int)
use text <- decode.field("text", decode.optional(decode.string))
use entities <- decode.field("entities", decode.optional(decode.list(message_entity_decoder())))
use is_private <- decode.field("is_private", decode.optional(decode.bool))
...
use send_date <- decode.field("send_date", decode.int)
use is_saved <- decode.field("is_saved", decode.optional(decode.bool))
use can_be_transferred <- decode.field("can_be_transferred", decode.optional(decode.bool))
use transfer_star_count <- decode.field("transfer_star_count", decode.optional(decode.int))
use next_transfer_date <- decode.field("next_transfer_date", decode.optional(decode.int))
...
use amount <- decode.field("amount", decode.int)
use nanostar_amount <- decode.field("nanostar_amount", decode.optional(decode.int))
decode.success(StarAmount(
      amount: amount,
...
decode.success(BotCommand(
      command: command,
      description: description))
}

pub fn bot_command_scope_default_decoder() -> decode.Decoder(BotCommandScopeDefault) {
use type_ <- decode.field("type_", decode.string)
decode.success(BotCommandScopeDefault(
      type_: type_))
}

pub fn bot_command_scope_all_private_chats_decoder() -> decode.Decoder(BotCommandScopeAllPrivateChats) {
use type_ <- decode.field("type_", decode.string)
decode.success(BotCommandScopeAllPrivateChats(
      type_: type_))
}

pub fn bot_command_scope_all_group_chats_decoder() -> decode.Decoder(BotCommandScopeAllGroupChats) {
use type_ <- decode.field("type_", decode.string)
decode.success(BotCommandScopeAllGroupChats(
      type_: type_))
}

pub fn bot_command_scope_all_chat_administrators_decoder() -> decode.Decoder(BotCommandScopeAllChatAdministrators) {
use type_ <- decode.field("type_", decode.string)
decode.success(BotCommandScopeAllChatAdministrators(
      type_: type_))
}
...
decode.success(BotCommandScopeChat(
      type_: type_,
      chat_id: chat_id))
}

pub fn bot_command_scope_chat_administrators_decoder() -> decode.Decoder(BotCommandScopeChatAdministrators) {
use type_ <- decode.field("type_", decode.string)
use chat_id <- decode.field("chat_id", int_or_string_decoder())
...
pub fn bot_command_scope_chat_member_decoder() -> decode.Decoder(BotCommandScopeChatMember) {
use type_ <- decode.field("type_", decode.string)
use chat_id <- decode.field("chat_id", int_or_string_decoder())
use user_id <- decode.field("user_id", decode.int)
...
decode.success(MenuButtonWebApp(
      type_: type_,
      text: text,
      web_app: web_app))
}
...
use type_ <- decode.field("type_", decode.string)
decode.success(MenuButtonDefault(
      type_: type_))
}

pub fn chat_boost_source_premium_decoder() -> decode.Decoder(ChatBoostSourcePremium) {
use source <- decode.field("source", decode.string)
use user <- decode.field("user", user_decoder())
decode.success(ChatBoostSourcePremium(
      source: source,
      user: user))
}

pub fn chat_boost_source_gift_code_decoder() -> decode.Decoder(ChatBoostSourceGiftCode) {
use source <- decode.field("source", decode.string)
use user <- decode.field("user", user_decoder())
decode.success(ChatBoostSourceGiftCode(
      source: source,
      user: user))
}

pub fn chat_boost_source_giveaway_decoder() -> decode.Decoder(ChatBoostSourceGiveaway) {
use source <- decode.field("source", decode.string)
use giveaway_message_id <- decode.field("giveaway_message_id", decode.int)
use user <- decode.field("user", decode.optional(user_decoder()))
use prize_star_count <- decode.field("prize_star_count", decode.optional(decode.int))
...
decode.success(ChatBoostUpdated(
      chat: chat,
      boost: boost))
}
...
use can_read_messages <- decode.field("can_read_messages", decode.optional(decode.bool))
use can_delete_sent_messages <- decode.field("can_delete_sent_messages", decode.optional(decode.bool))
use can_delete_all_messages <- decode.field("can_delete_all_messages", decode.optional(decode.bool))
use can_edit_name <- decode.field("can_edit_name", decode.optional(decode.bool))
use can_edit_bio <- decode.field("can_edit_bio", decode.optional(decode.bool))
use can_edit_profile_photo <- decode.field("can_edit_profile_photo", decode.optional(decode.bool))
use can_edit_username <- decode.field("can_edit_username", decode.optional(decode.bool))
use can_change_gift_settings <- decode.field("can_change_gift_settings", decode.optional(decode.bool))
use can_view_gifts_and_stars <- decode.field("can_view_gifts_and_stars", decode.optional(decode.bool))
use can_convert_gifts_to_stars <- decode.field("can_convert_gifts_to_stars", decode.optional(decode.bool))
use can_transfer_and_upgrade_gifts <- decode.field("can_transfer_and_upgrade_gifts", decode.optional(decode.bool))
use can_transfer_stars <- decode.field("can_transfer_stars", decode.optional(decode.bool))
use can_manage_stories <- decode.field("can_manage_stories", decode.optional(decode.bool))
...
use user_chat_id <- decode.field("user_chat_id", decode.int)
use date <- decode.field("date", decode.int)
use rights <- decode.field("rights", decode.optional(business_bot_rights_decoder()))
...
pub fn business_messages_deleted_decoder() -> decode.Decoder(BusinessMessagesDeleted) {
use business_connection_id <- decode.field("business_connection_id", decode.string)
use chat <- decode.field("chat", chat_decoder())
...
use inline_message_id <- decode.field("inline_message_id", decode.optional(decode.string))
decode.success(SentWebAppMessage(
      inline_message_id: inline_message_id))
}
...
pub fn prepared_keyboard_button_decoder() -> decode.Decoder(PreparedKeyboardButton) {
use id <- decode.field("id", decode.string)
decode.success(PreparedKeyboardButton(
      id: id))
}
...
use parse_mode <- decode.field("parse_mode", decode.optional(decode.string))
use caption_entities <- decode.field("caption_entities", decode.optional(decode.list(message_entity_decoder())))
use disable_content_type_detection <- decode.field("disable_content_type_detection", decode.optional(decode.bool))
...
use type_ <- decode.field("type_", decode.string)
use media <- decode.field("media", decode.string)
decode.success(InputPaidMediaPhoto(
      type_: type_,
      media: media))
}
...
pub fn input_profile_photo_static_decoder() -> decode.Decoder(InputProfilePhotoStatic) {
use type_ <- decode.field("type_", decode.string)
use photo <- decode.field("photo", decode.string)
decode.success(InputProfilePhotoStatic(
      type_: type_,
      photo: photo))
}

pub fn input_profile_photo_animated_decoder() -> decode.Decoder(InputProfilePhotoAnimated) {
use type_ <- decode.field("type_", decode.string)
use animation <- decode.field("animation", decode.string)
use main_frame_timestamp <- decode.field("main_frame_timestamp", decode.optional(decode.float))
...
use type_ <- decode.field("type_", decode.string)
use photo <- decode.field("photo", decode.string)
decode.success(InputStoryContent(
      type_: type_,
      photo: photo))
}

pub fn input_story_content_photo_decoder() -> decode.Decoder(InputStoryContentPhoto) {
use type_ <- decode.field("type_", decode.string)
use photo <- decode.field("photo", decode.string)
decode.success(InputStoryContentPhoto(
      type_: type_,
      photo: photo))
}

pub fn input_story_content_video_decoder() -> decode.Decoder(InputStoryContentVideo) {
use type_ <- decode.field("type_", decode.string)
use video <- decode.field("video", decode.string)
use duration <- decode.field("duration", decode.optional(decode.float))
use cover_frame_timestamp <- decode.field("cover_frame_timestamp", decode.optional(decode.float))
...
use premium_animation <- decode.field("premium_animation", decode.optional(file_decoder()))
use mask_position <- decode.field("mask_position", decode.optional(mask_position_decoder()))
use custom_emoji_id <- decode.field("custom_emoji_id", decode.optional(decode.string))
use needs_repainting <- decode.field("needs_repainting", decode.optional(decode.bool))
use file_size <- decode.field("file_size", decode.optional(decode.int))
...
use mask_position <- decode.field("mask_position", decode.optional(mask_position_decoder()))
use keywords <- decode.field("keywords", decode.optional(decode.list(decode.string)))
...
pub fn inline_query_results_button_decoder() -> decode.Decoder(InlineQueryResultsButton) {
use text <- decode.field("text", decode.string)
use web_app <- decode.field("web_app", decode.optional(web_app_info_decoder()))
use start_parameter <- decode.field("start_parameter", decode.optional(decode.string))
...
pub fn inline_query_result_article_decoder() -> decode.Decoder(InlineQueryResultArticle) {
use type_ <- decode.field("type_", decode.string)
use id <- decode.field("id", decode.string)
use title <- decode.field("title", decode.string)
use input_message_content <- decode.field("input_message_content", input_message_content_decoder())
use reply_markup <- decode.field("reply_markup", decode.optional(inline_keyboard_markup_decoder()))
use url <- decode.field("url", decode.optional(decode.string))
use description <- decode.field("description", decode.optional(decode.string))
use thumbnail_url <- decode.field("thumbnail_url", decode.optional(decode.string))
use thumbnail_width <- decode.field("thumbnail_width", decode.optional(decode.int))
use thumbnail_height <- decode.field("thumbnail_height", decode.optional(decode.int))
...
pub fn inline_query_result_photo_decoder() -> decode.Decoder(InlineQueryResultPhoto) {
use type_ <- decode.field("type_", decode.string)
use id <- decode.field("id", decode.string)
...
use show_caption_above_media <- decode.field("show_caption_above_media", decode.optional(decode.bool))
use reply_markup <- decode.field("reply_markup", decode.optional(inline_keyboard_markup_decoder()))
use input_message_content <- decode.field("input_message_content", decode.optional(input_message_content_decoder()))
...
use thumbnail_url <- decode.field("thumbnail_url", decode.string)
use thumbnail_mime_type <- decode.field("thumbnail_mime_type", decode.optional(decode.string))
use title <- decode.field("title", decode.optional(decode.string))
use caption <- decode.field("caption", decode.optional(decode.string))
use parse_mode <- decode.field("parse_mode", decode.optional(decode.string))
use caption_entities <- decode.field("caption_entities", decode.optional(decode.list(message_entity_decoder())))
...
pub fn inline_query_result_mpeg4_gif_decoder() -> decode.Decoder(InlineQueryResultMpeg4Gif) {
use type_ <- decode.field("type_", decode.string)
use id <- decode.field("id", decode.string)
...
use mpeg4_duration <- decode.field("mpeg4_duration", decode.optional(decode.int))
use thumbnail_url <- decode.field("thumbnail_url", decode.string)
use thumbnail_mime_type <- decode.field("thumbnail_mime_type", decode.optional(decode.string))
use title <- decode.field("title", decode.optional(decode.string))
use caption <- decode.field("caption", decode.optional(decode.string))
...
pub fn inline_query_result_video_decoder() -> decode.Decoder(InlineQueryResultVideo) {
use type_ <- decode.field("type_", decode.string)
use id <- decode.field("id", decode.string)
...
use video_duration <- decode.field("video_duration", decode.optional(decode.int))
use description <- decode.field("description", decode.optional(decode.string))
use reply_markup <- decode.field("reply_markup", decode.optional(inline_keyboard_markup_decoder()))
use input_message_content <- decode.field("input_message_content", decode.optional(input_message_content_decoder()))
...
pub fn inline_query_result_audio_decoder() -> decode.Decoder(InlineQueryResultAudio) {
use type_ <- decode.field("type_", decode.string)
use id <- decode.field("id", decode.string)
...
use caption_entities <- decode.field("caption_entities", decode.optional(decode.list(message_entity_decoder())))
use performer <- decode.field("performer", decode.optional(decode.string))
use audio_duration <- decode.field("audio_duration", decode.optional(decode.int))
use reply_markup <- decode.field("reply_markup", decode.optional(inline_keyboard_markup_decoder()))
use input_message_content <- decode.field("input_message_content", decode.optional(input_message_content_decoder()))
...
pub fn inline_query_result_voice_decoder() -> decode.Decoder(InlineQueryResultVoice) {
use type_ <- decode.field("type_", decode.string)
use id <- decode.field("id", decode.string)
...
use parse_mode <- decode.field("parse_mode", decode.optional(decode.string))
use caption_entities <- decode.field("caption_entities", decode.optional(decode.list(message_entity_decoder())))
use voice_duration <- decode.field("voice_duration", decode.optional(decode.int))
use reply_markup <- decode.field("reply_markup", decode.optional(inline_keyboard_markup_decoder()))
use input_message_content <- decode.field("input_message_content", decode.optional(input_message_content_decoder()))
...
pub fn inline_query_result_document_decoder() -> decode.Decoder(InlineQueryResultDocument) {
use type_ <- decode.field("type_", decode.string)
use id <- decode.field("id", decode.string)
use title <- decode.field("title", decode.string)
use caption <- decode.field("caption", decode.optional(decode.string))
...
pub fn inline_query_result_location_decoder() -> decode.Decoder(InlineQueryResultLocation) {
use type_ <- decode.field("type_", decode.string)
use id <- decode.field("id", decode.string)
use latitude <- decode.field("latitude", decode.float)
use longitude <- decode.field("longitude", decode.float)
...
pub fn inline_query_result_venue_decoder() -> decode.Decoder(InlineQueryResultVenue) {
use type_ <- decode.field("type_", decode.string)
use id <- decode.field("id", decode.string)
use latitude <- decode.field("latitude", decode.float)
use longitude <- decode.field("longitude", decode.float)
...
pub fn inline_query_result_contact_decoder() -> decode.Decoder(InlineQueryResultContact) {
use type_ <- decode.field("type_", decode.string)
use id <- decode.field("id", decode.string)
use phone_number <- decode.field("phone_number", decode.string)
use first_name <- decode.field("first_name", decode.string)
...
pub fn inline_query_result_game_decoder() -> decode.Decoder(InlineQueryResultGame) {
use type_ <- decode.field("type_", decode.string)
use id <- decode.field("id", decode.string)
...
pub fn inline_query_result_cached_photo_decoder() -> decode.Decoder(InlineQueryResultCachedPhoto) {
use type_ <- decode.field("type_", decode.string)
use id <- decode.field("id", decode.string)
...
pub fn inline_query_result_cached_gif_decoder() -> decode.Decoder(InlineQueryResultCachedGif) {
use type_ <- decode.field("type_", decode.string)
use id <- decode.field("id", decode.string)
...
pub fn inline_query_result_cached_mpeg4_gif_decoder() -> decode.Decoder(InlineQueryResultCachedMpeg4Gif) {
use type_ <- decode.field("type_", decode.string)
use id <- decode.field("id", decode.string)
...
pub fn inline_query_result_cached_sticker_decoder() -> decode.Decoder(InlineQueryResultCachedSticker) {
use type_ <- decode.field("type_", decode.string)
use id <- decode.field("id", decode.string)
...
pub fn inline_query_result_cached_document_decoder() -> decode.Decoder(InlineQueryResultCachedDocument) {
use type_ <- decode.field("type_", decode.string)
use id <- decode.field("id", decode.string)
use title <- decode.field("title", decode.string)
...
pub fn inline_query_result_cached_video_decoder() -> decode.Decoder(InlineQueryResultCachedVideo) {
use type_ <- decode.field("type_", decode.string)
use id <- decode.field("id", decode.string)
...
pub fn inline_query_result_cached_voice_decoder() -> decode.Decoder(InlineQueryResultCachedVoice) {
use type_ <- decode.field("type_", decode.string)
use id <- decode.field("id", decode.string)
...
pub fn inline_query_result_cached_audio_decoder() -> decode.Decoder(InlineQueryResultCachedAudio) {
use type_ <- decode.field("type_", decode.string)
use id <- decode.field("id", decode.string)
...
pub fn input_text_message_content_decoder() -> decode.Decoder(InputTextMessageContent) {
...
pub fn input_location_message_content_decoder() -> decode.Decoder(InputLocationMessageContent) {
use latitude <- decode.field("latitude", decode.float)
use longitude <- decode.field("longitude", decode.float)
use horizontal_accuracy <- decode.field("horizontal_accuracy", decode.optional(decode.float))
use live_period <- decode.field("live_period", decode.optional(decode.int))
...
pub fn input_venue_message_content_decoder() -> decode.Decoder(InputVenueMessageContent) {
use latitude <- decode.field("latitude", decode.float)
use longitude <- decode.field("longitude", decode.float)
use title <- decode.field("title", decode.string)
use address <- decode.field("address", decode.string)
...
pub fn input_contact_message_content_decoder() -> decode.Decoder(InputContactMessageContent) {
use phone_number <- decode.field("phone_number", decode.string)
use first_name <- decode.field("first_name", decode.string)
use last_name <- decode.field("last_name", decode.optional(decode.string))
use vcard <- decode.field("vcard", decode.optional(decode.string))
...
pub fn input_invoice_message_content_decoder() -> decode.Decoder(InputInvoiceMessageContent) {
use title <- decode.field("title", decode.string)
use description <- decode.field("description", decode.string)
use payload <- decode.field("payload", decode.string)
use provider_token <- decode.field("provider_token", decode.optional(decode.string))
use currency <- decode.field("currency", decode.string)
use prices <- decode.field("prices", decode.list(labeled_price_decoder()))
use max_tip_amount <- decode.field("max_tip_amount", decode.optional(decode.int))
use suggested_tip_amounts <- decode.field("suggested_tip_amounts", decode.optional(decode.list(decode.int)))
use provider_data <- decode.field("provider_data", decode.optional(decode.string))
...
use need_phone_number <- decode.field("need_phone_number", decode.optional(decode.bool))
use need_email <- decode.field("need_email", decode.optional(decode.bool))
use need_shipping_address <- decode.field("need_shipping_address", decode.optional(decode.bool))
use send_phone_number_to_provider <- decode.field("send_phone_number_to_provider", decode.optional(decode.bool))
use send_email_to_provider <- decode.field("send_email_to_provider", decode.optional(decode.bool))
...
use name <- decode.field("name", decode.optional(decode.string))
use phone_number <- decode.field("phone_number", decode.optional(decode.string))
use email <- decode.field("email", decode.optional(decode.string))
use shipping_address <- decode.field("shipping_address", decode.optional(shipping_address_decoder()))
...
use subscription_expiration_date <- decode.field("subscription_expiration_date", decode.optional(decode.int))
use is_recurring <- decode.field("is_recurring", decode.optional(decode.bool))
use is_first_recurring <- decode.field("is_first_recurring", decode.optional(decode.bool))
use shipping_option_id <- decode.field("shipping_option_id", decode.optional(decode.string))
use order_info <- decode.field("order_info", decode.optional(order_info_decoder()))
use telegram_payment_charge_id <- decode.field("telegram_payment_charge_id", decode.string)
use provider_payment_charge_id <- decode.field("provider_payment_charge_id", decode.string)
...
use invoice_payload <- decode.field("invoice_payload", decode.string)
use telegram_payment_charge_id <- decode.field("telegram_payment_charge_id", decode.string)
use provider_payment_charge_id <- decode.field("provider_payment_charge_id", decode.optional(decode.string))
...
use from <- decode.field("from", user_decoder())
use invoice_payload <- decode.field("invoice_payload", decode.string)
use shipping_address <- decode.field("shipping_address", shipping_address_decoder())
...
pub fn revenue_withdrawal_state_pending_decoder() -> decode.Decoder(RevenueWithdrawalStatePending) {
use type_ <- decode.field("type_", decode.string)
decode.success(RevenueWithdrawalStatePending(
      type_: type_))
}

pub fn revenue_withdrawal_state_succeeded_decoder() -> decode.Decoder(RevenueWithdrawalStateSucceeded) {
use type_ <- decode.field("type_", decode.string)
use date <- decode.field("date", decode.int)
use url <- decode.field("url", decode.string)
...
pub fn revenue_withdrawal_state_failed_decoder() -> decode.Decoder(RevenueWithdrawalStateFailed) {
use type_ <- decode.field("type_", decode.string)
decode.success(RevenueWithdrawalStateFailed(
      type_: type_))
}

pub fn affiliate_info_decoder() -> decode.Decoder(AffiliateInfo) {
use affiliate_user <- decode.field("affiliate_user", decode.optional(user_decoder()))
use affiliate_chat <- decode.field("affiliate_chat", decode.optional(chat_decoder()))
...
pub fn transaction_partner_user_decoder() -> decode.Decoder(TransactionPartnerUser) {
use type_ <- decode.field("type_", decode.string)
use transaction_type <- decode.field("transaction_type", decode.string)
use user <- decode.field("user", user_decoder())
use affiliate <- decode.field("affiliate", decode.optional(affiliate_info_decoder()))
use invoice_payload <- decode.field("invoice_payload", decode.optional(decode.string))
use subscription_period <- decode.field("subscription_period", decode.optional(decode.int))
use paid_media <- decode.field("paid_media", decode.optional(decode.list(paid_media_decoder())))
use paid_media_payload <- decode.field("paid_media_payload", decode.optional(decode.string))
use gift <- decode.field("gift", decode.optional(gift_decoder()))
use premium_subscription_duration <- decode.field("premium_subscription_duration", decode.optional(decode.int))
...
pub fn transaction_partner_chat_decoder() -> decode.Decoder(TransactionPartnerChat) {
use type_ <- decode.field("type_", decode.string)
use chat <- decode.field("chat", chat_decoder())
use gift <- decode.field("gift", decode.optional(gift_decoder()))
decode.success(TransactionPartnerChat(
      type_: type_,
      chat: chat,
      gift: gift))
}

pub fn transaction_partner_affiliate_program_decoder() -> decode.Decoder(TransactionPartnerAffiliateProgram) {
use type_ <- decode.field("type_", decode.string)
use sponsor_user <- decode.field("sponsor_user", decode.optional(user_decoder()))
use commission_per_mille <- decode.field("commission_per_mille", decode.int)
...
pub fn transaction_partner_fragment_decoder() -> decode.Decoder(TransactionPartnerFragment) {
use type_ <- decode.field("type_", decode.string)
use withdrawal_state <- decode.field("withdrawal_state", decode.optional(revenue_withdrawal_state_decoder()))
decode.success(TransactionPartnerFragment(
      type_: type_,
      withdrawal_state: withdrawal_state))
}

pub fn transaction_partner_telegram_ads_decoder() -> decode.Decoder(TransactionPartnerTelegramAds) {
use type_ <- decode.field("type_", decode.string)
decode.success(TransactionPartnerTelegramAds(
      type_: type_))
}

pub fn transaction_partner_telegram_api_decoder() -> decode.Decoder(TransactionPartnerTelegramApi) {
use type_ <- decode.field("type_", decode.string)
...
pub fn transaction_partner_other_decoder() -> decode.Decoder(TransactionPartnerOther) {
use type_ <- decode.field("type_", decode.string)
decode.success(TransactionPartnerOther(
      type_: type_))
}
...
use nanostar_amount <- decode.field("nanostar_amount", decode.optional(decode.int))
use date <- decode.field("date", decode.int)
use source <- decode.field("source", decode.optional(transaction_partner_decoder()))
use receiver <- decode.field("receiver", decode.optional(transaction_partner_decoder()))
...
use transactions <- decode.field("transactions", decode.list(star_transaction_decoder()))
decode.success(StarTransactions(
      transactions: transactions))
}

pub fn passport_data_decoder() -> decode.Decoder(PassportData) {
use data <- decode.field("data", decode.list(encrypted_passport_element_decoder()))
use credentials <- decode.field("credentials", encrypted_credentials_decoder())
decode.success(PassportData(
      data: data,
...
pub fn encrypted_passport_element_decoder() -> decode.Decoder(EncryptedPassportElement) {
use type_ <- decode.field("type_", decode.string)
use data <- decode.field("data", decode.optional(decode.string))
use phone_number <- decode.field("phone_number", decode.optional(decode.string))
use email <- decode.field("email", decode.optional(decode.string))
use files <- decode.field("files", decode.optional(decode.list(passport_file_decoder())))
use front_side <- decode.field("front_side", decode.optional(passport_file_decoder()))
use reverse_side <- decode.field("reverse_side", decode.optional(passport_file_decoder()))
use selfie <- decode.field("selfie", decode.optional(passport_file_decoder()))
use translation <- decode.field("translation", decode.optional(decode.list(passport_file_decoder())))
...
decode.success(EncryptedCredentials(
      data: data,
      hash: hash,
      secret: secret))
}

pub fn passport_element_error_data_field_decoder() -> decode.Decoder(PassportElementErrorDataField) {
use source <- decode.field("source", decode.string)
use type_ <- decode.field("type_", decode.string)
...
pub fn passport_element_error_front_side_decoder() -> decode.Decoder(PassportElementErrorFrontSide) {
use source <- decode.field("source", decode.string)
use type_ <- decode.field("type_", decode.string)
...
pub fn passport_element_error_reverse_side_decoder() -> decode.Decoder(PassportElementErrorReverseSide) {
use source <- decode.field("source", decode.string)
use type_ <- decode.field("type_", decode.string)
use file_hash <- decode.field("file_hash", decode.string)
use message <- decode.field("message", decode.string)
...
pub fn passport_element_error_selfie_decoder() -> decode.Decoder(PassportElementErrorSelfie) {
use source <- decode.field("source", decode.string)
use type_ <- decode.field("type_", decode.string)
use file_hash <- decode.field("file_hash", decode.string)
use message <- decode.field("message", decode.string)
...
pub fn passport_element_error_file_decoder() -> decode.Decoder(PassportElementErrorFile) {
use source <- decode.field("source", decode.string)
use type_ <- decode.field("type_", decode.string)
use file_hash <- decode.field("file_hash", decode.string)
use message <- decode.field("message", decode.string)
...
pub fn passport_element_error_files_decoder() -> decode.Decoder(PassportElementErrorFiles) {
use source <- decode.field("source", decode.string)
use type_ <- decode.field("type_", decode.string)
...
pub fn passport_element_error_translation_file_decoder() -> decode.Decoder(PassportElementErrorTranslationFile) {
use source <- decode.field("source", decode.string)
use type_ <- decode.field("type_", decode.string)
use file_hash <- decode.field("file_hash", decode.string)
use message <- decode.field("message", decode.string)
...
pub fn passport_element_error_translation_files_decoder() -> decode.Decoder(PassportElementErrorTranslationFiles) {
use source <- decode.field("source", decode.string)
use type_ <- decode.field("type_", decode.string)
use file_hashes <- decode.field("file_hashes", decode.list(decode.string))
use message <- decode.field("message", decode.string)
...
pub fn passport_element_error_unspecified_decoder() -> decode.Decoder(PassportElementErrorUnspecified) {
use source <- decode.field("source", decode.string)
use type_ <- decode.field("type_", decode.string)
...
use disable_edit_message <- decode.field("disable_edit_message", decode.optional(decode.bool))
...
#("edited_channel_post", json.nullable(update.edited_channel_post, encode_message)),
#("business_connection", json.nullable(update.business_connection, encode_business_connection)),
...
#("chosen_inline_result", json.nullable(update.chosen_inline_result, encode_chosen_inline_result)),
#("callback_query", json.nullable(update.callback_query, encode_callback_query)),
#("shipping_query", json.nullable(update.shipping_query, encode_shipping_query)),
#("pre_checkout_query", json.nullable(update.pre_checkout_query, encode_pre_checkout_query)),
#("purchased_paid_media", json.nullable(update.purchased_paid_media, encode_paid_media_purchased)),
#("poll", json.nullable(update.poll, encode_poll)),
#("poll_answer", json.nullable(update.poll_answer, encode_poll_answer)),
#("my_chat_member", json.nullable(update.my_chat_member, encode_chat_member_updated)),
#("chat_member", json.nullable(update.chat_member, encode_chat_member_updated)),
#("chat_join_request", json.nullable(update.chat_join_request, encode_chat_join_request)),
#("chat_boost", json.nullable(update.chat_boost, encode_chat_boost_updated)),
#("removed_chat_boost", json.nullable(update.removed_chat_boost, encode_chat_boost_removed)),
#("managed_bot", json.nullable(update.managed_bot, encode_managed_bot_updated)),
  ])
}
...
#("last_error_message", json.nullable(webhook_info.last_error_message, json.string)),
#("last_synchronization_error_date", json.nullable(webhook_info.last_synchronization_error_date, json.int)),
#("max_connections", json.nullable(webhook_info.max_connections, json.int)),
#("allowed_updates", json.nullable(webhook_info.allowed_updates, json.array(_, json.string))),
  ])
}
...
#("allows_users_to_create_topics", json.nullable(user.allows_users_to_create_topics, json.bool)),
...
#("is_direct_messages", json.nullable(chat_full_info.is_direct_messages, json.bool)),
...
#("active_usernames", json.nullable(chat_full_info.active_usernames, json.array(_, json.string))),
#("birthdate", json.nullable(chat_full_info.birthdate, encode_birthdate)),
#("business_intro", json.nullable(chat_full_info.business_intro, encode_business_intro)),
#("business_location", json.nullable(chat_full_info.business_location, encode_business_location)),
#("business_opening_hours", json.nullable(chat_full_info.business_opening_hours, encode_business_opening_hours)),
...
#("available_reactions", json.nullable(chat_full_info.available_reactions, json.array(_, encode_reaction_type))),
#("background_custom_emoji_id", json.nullable(chat_full_info.background_custom_emoji_id, json.string)),
#("profile_accent_color_id", json.nullable(chat_full_info.profile_accent_color_id, json.int)),
#("profile_background_custom_emoji_id", json.nullable(chat_full_info.profile_background_custom_emoji_id, json.string)),
#("emoji_status_custom_emoji_id", json.nullable(chat_full_info.emoji_status_custom_emoji_id, json.string)),
#("emoji_status_expiration_date", json.nullable(chat_full_info.emoji_status_expiration_date, json.int)),
#("bio", json.nullable(chat_full_info.bio, json.string)),
#("has_private_forwards", json.nullable(chat_full_info.has_private_forwards, json.bool)),
#("has_restricted_voice_and_video_messages", json.nullable(chat_full_info.has_restricted_voice_and_video_messages, json.bool)),
#("join_to_send_messages", json.nullable(chat_full_info.join_to_send_messages, json.bool)),
#("join_by_request", json.nullable(chat_full_info.join_by_request, json.bool)),
...
#("pinned_message", json.nullable(chat_full_info.pinned_message, encode_message)),
#("permissions", json.nullable(chat_full_info.permissions, encode_chat_permissions)),
#("accepted_gift_types", encode_accepted_gift_types(chat_full_info.accepted_gift_types)),
#("can_send_paid_media", json.nullable(chat_full_info.can_send_paid_media, json.bool)),
#("slow_mode_delay", json.nullable(chat_full_info.slow_mode_delay, json.int)),
#("unrestrict_boost_count", json.nullable(chat_full_info.unrestrict_boost_count, json.int)),
#("message_auto_delete_time", json.nullable(chat_full_info.message_auto_delete_time, json.int)),
#("has_aggressive_anti_spam_enabled", json.nullable(chat_full_info.has_aggressive_anti_spam_enabled, json.bool)),
#("has_hidden_members", json.nullable(chat_full_info.has_hidden_members, json.bool)),
#("has_protected_content", json.nullable(chat_full_info.has_protected_content, json.bool)),
#("has_visible_history", json.nullable(chat_full_info.has_visible_history, json.bool)),
#("sticker_set_name", json.nullable(chat_full_info.sticker_set_name, json.string)),
#("can_set_sticker_set", json.nullable(chat_full_info.can_set_sticker_set, json.bool)),
#("custom_emoji_sticker_set_name", json.nullable(chat_full_info.custom_emoji_sticker_set_name, json.string)),
...
#("first_profile_audio", json.nullable(chat_full_info.first_profile_audio, encode_audio)),
#("unique_gift_colors", json.nullable(chat_full_info.unique_gift_colors, encode_unique_gift_colors)),
#("paid_message_star_count", json.nullable(chat_full_info.paid_message_star_count, json.int)),
  ])
}
...
#("direct_messages_topic", json.nullable(message.direct_messages_topic, encode_direct_messages_topic)),
...
#("is_automatic_forward", json.nullable(message.is_automatic_forward, json.bool)),
#("reply_to_message", json.nullable(message.reply_to_message, encode_message)),
#("external_reply", json.nullable(message.external_reply, encode_external_reply_info)),
...
#("entities", json.nullable(message.entities, json.array(_, encode_message_entity))),
#("link_preview_options", json.nullable(message.link_preview_options, encode_link_preview_options)),
#("suggested_post_info", json.nullable(message.suggested_post_info, encode_suggested_post_info)),
...
#("caption_entities", json.nullable(message.caption_entities, json.array(_, encode_message_entity))),
#("show_caption_above_media", json.nullable(message.show_caption_above_media, json.bool)),
...
#("new_chat_members", json.nullable(message.new_chat_members, json.array(_, encode_user))),
#("left_chat_member", json.nullable(message.left_chat_member, encode_user)),
#("chat_owner_left", json.nullable(message.chat_owner_left, encode_chat_owner_left)),
#("chat_owner_changed", json.nullable(message.chat_owner_changed, encode_chat_owner_changed)),
#("new_chat_title", json.nullable(message.new_chat_title, json.string)),
#("new_chat_photo", json.nullable(message.new_chat_photo, json.array(_, encode_photo_size))),
#("delete_chat_photo", json.nullable(message.delete_chat_photo, json.bool)),
#("group_chat_created", json.nullable(message.group_chat_created, json.bool)),
#("supergroup_chat_created", json.nullable(message.supergroup_chat_created, json.bool)),
#("channel_chat_created", json.nullable(message.channel_chat_created, json.bool)),
#("message_auto_delete_timer_changed", json.nullable(message.message_auto_delete_timer_changed, encode_message_auto_delete_timer_changed)),
#("migrate_to_chat_id", json.nullable(message.migrate_to_chat_id, json.int)),
#("migrate_from_chat_id", json.nullable(message.migrate_from_chat_id, json.int)),
#("pinned_message", json.nullable(message.pinned_message, encode_maybe_inaccessible_message)),
#("invoice", json.nullable(message.invoice, encode_invoice)),
#("successful_payment", json.nullable(message.successful_payment, encode_successful_payment)),
#("refunded_payment", json.nullable(message.refunded_payment, encode_refunded_payment)),
...
#("unique_gift", json.nullable(message.unique_gift, encode_unique_gift_info)),
#("gift_upgrade_sent", json.nullable(message.gift_upgrade_sent, encode_gift_info)),
#("connected_website", json.nullable(message.connected_website, json.string)),
#("write_access_allowed", json.nullable(message.write_access_allowed, encode_write_access_allowed)),
#("passport_data", json.nullable(message.passport_data, encode_passport_data)),
#("proximity_alert_triggered", json.nullable(message.proximity_alert_triggered, encode_proximity_alert_triggered)),
#("boost_added", json.nullable(message.boost_added, encode_chat_boost_added)),
#("chat_background_set", json.nullable(message.chat_background_set, encode_chat_background)),
#("checklist_tasks_done", json.nullable(message.checklist_tasks_done, encode_checklist_tasks_done)),
#("checklist_tasks_added", json.nullable(message.checklist_tasks_added, encode_checklist_tasks_added)),
#("direct_message_price_changed", json.nullable(message.direct_message_price_changed, encode_direct_message_price_changed)),
#("forum_topic_created", json.nullable(message.forum_topic_created, encode_forum_topic_created)),
#("forum_topic_edited", json.nullable(message.forum_topic_edited, encode_forum_topic_edited)),
#("forum_topic_closed", json.nullable(message.forum_topic_closed, encode_forum_topic_closed)),
#("forum_topic_reopened", json.nullable(message.forum_topic_reopened, encode_forum_topic_reopened)),
#("general_forum_topic_hidden", json.nullable(message.general_forum_topic_hidden, encode_general_forum_topic_hidden)),
#("general_forum_topic_unhidden", json.nullable(message.general_forum_topic_unhidden, encode_general_forum_topic_unhidden)),
#("giveaway_created", json.nullable(message.giveaway_created, encode_giveaway_created)),
#("giveaway", json.nullable(message.giveaway, encode_giveaway)),
#("giveaway_winners", json.nullable(message.giveaway_winners, encode_giveaway_winners)),
#("giveaway_completed", json.nullable(message.giveaway_completed, encode_giveaway_completed)),
#("managed_bot_created", json.nullable(message.managed_bot_created, encode_managed_bot_created)),
#("paid_message_price_changed", json.nullable(message.paid_message_price_changed, encode_paid_message_price_changed)),
#("poll_option_added", json.nullable(message.poll_option_added, encode_poll_option_added)),
#("poll_option_deleted", json.nullable(message.poll_option_deleted, encode_poll_option_deleted)),
#("suggested_post_approved", json.nullable(message.suggested_post_approved, encode_suggested_post_approved)),
#("suggested_post_approval_failed", json.nullable(message.suggested_post_approval_failed, encode_suggested_post_approval_failed)),
#("suggested_post_declined", json.nullable(message.suggested_post_declined, encode_suggested_post_declined)),
#("suggested_post_paid", json.nullable(message.suggested_post_paid, encode_suggested_post_paid)),
#("suggested_post_refunded", json.nullable(message.suggested_post_refunded, encode_suggested_post_refunded)),
#("video_chat_scheduled", json.nullable(message.video_chat_scheduled, encode_video_chat_scheduled)),
#("video_chat_started", json.nullable(message.video_chat_started, encode_video_chat_started)),
#("video_chat_ended", json.nullable(message.video_chat_ended, encode_video_chat_ended)),
#("video_chat_participants_invited", json.nullable(message.video_chat_participants_invited, encode_video_chat_participants_invited)),
#("web_app_data", json.nullable(message.web_app_data, encode_web_app_data)),
#("reply_markup", json.nullable(message.reply_markup, encode_inline_keyboard_markup)),
  ])
}
...
pub fn encode_inaccessible_message(inaccessible_message: InaccessibleMessage) -> Json {
json_object_filter_nulls([
...
#("custom_emoji_id", json.nullable(message_entity.custom_emoji_id, json.string)),
#("unix_time", json.nullable(message_entity.unix_time, json.int)),
#("date_time_format", json.nullable(message_entity.date_time_format, json.string)),
  ])
}
...
#("entities", json.nullable(text_quote.entities, json.array(_, encode_message_entity))),
#("position", json.int(text_quote.position)),
#("is_manual", json.nullable(text_quote.is_manual, json.bool)),
  ])
}

pub fn encode_external_reply_info(external_reply_info: ExternalReplyInfo) -> Json {
json_object_filter_nulls([
...
#("link_preview_options", json.nullable(external_reply_info.link_preview_options, encode_link_preview_options)),
...
#("video_note", json.nullable(external_reply_info.video_note, encode_video_note)),
#("voice", json.nullable(external_reply_info.voice, encode_voice)),
#("has_media_spoiler", json.nullable(external_reply_info.has_media_spoiler, json.bool)),
#("checklist", json.nullable(external_reply_info.checklist, encode_checklist)),
...
#("giveaway_winners", json.nullable(external_reply_info.giveaway_winners, encode_giveaway_winners)),
...
#("allow_sending_without_reply", json.nullable(reply_parameters.allow_sending_without_reply, json.bool)),
#("quote", json.nullable(reply_parameters.quote, json.string)),
#("quote_parse_mode", json.nullable(reply_parameters.quote_parse_mode, json.string)),
#("quote_entities", json.nullable(reply_parameters.quote_entities, json.array(_, encode_message_entity))),
#("quote_position", json.nullable(reply_parameters.quote_position, json.int)),
#("checklist_task_id", json.nullable(reply_parameters.checklist_task_id, json.int)),
#("poll_option_id", json.nullable(reply_parameters.poll_option_id, json.string)),
  ])
}

pub fn encode_message_origin_user(message_origin_user: MessageOriginUser) -> Json {
json_object_filter_nulls([
...
pub fn encode_message_origin_hidden_user(message_origin_hidden_user: MessageOriginHiddenUser) -> Json {
json_object_filter_nulls([
#("type", json.string(message_origin_hidden_user.type_)),
#("date", json.int(message_origin_hidden_user.date)),
#("sender_user_name", json.string(message_origin_hidden_user.sender_user_name)),
  ])
}

pub fn encode_message_origin_chat(message_origin_chat: MessageOriginChat) -> Json {
json_object_filter_nulls([
...
#("author_signature", json.nullable(message_origin_chat.author_signature, json.string)),
  ])
}

pub fn encode_message_origin_channel(message_origin_channel: MessageOriginChannel) -> Json {
json_object_filter_nulls([
...
#("author_signature", json.nullable(message_origin_channel.author_signature, json.string)),
  ])
}
...
#("qualities", json.nullable(video.qualities, json.array(_, encode_video_quality))),
...
#("paid_media", json.array(_, encode_paid_media)(paid_media_info.paid_media)),
  ])
}
...
#("option_persistent_ids", json.array(_, json.string)(poll_answer.option_persistent_ids)),
  ])
}
...
#("question_entities", json.nullable(poll.question_entities, json.array(_, encode_message_entity))),
...
#("text_entities", json.nullable(checklist_task.text_entities, json.array(_, encode_message_entity))),
#("completed_by_user", json.nullable(checklist_task.completed_by_user, encode_user)),
#("completed_by_chat", json.nullable(checklist_task.completed_by_chat, encode_chat)),
#("completion_date", json.nullable(checklist_task.completion_date, json.int)),
  ])
}
...
#("title_entities", json.nullable(checklist.title_entities, json.array(_, encode_message_entity))),
#("tasks", json.array(_, encode_checklist_task)(checklist.tasks)),
#("others_can_add_tasks", json.nullable(checklist.others_can_add_tasks, json.bool)),
#("others_can_mark_tasks_as_done", json.nullable(checklist.others_can_mark_tasks_as_done, json.bool)),
  ])
}

pub fn encode_input_checklist_task(input_checklist_task: InputChecklistTask) -> Json {
json_object_filter_nulls([
...
#("text_entities", json.nullable(input_checklist_task.text_entities, json.array(_, encode_message_entity))),
  ])
}
...
#("title_entities", json.nullable(input_checklist.title_entities, json.array(_, encode_message_entity))),
#("tasks", json.array(_, encode_input_checklist_task)(input_checklist.tasks)),
#("others_can_add_tasks", json.nullable(input_checklist.others_can_add_tasks, json.bool)),
#("others_can_mark_tasks_as_done", json.nullable(input_checklist.others_can_mark_tasks_as_done, json.bool)),
  ])
}

pub fn encode_checklist_tasks_done(checklist_tasks_done: ChecklistTasksDone) -> Json {
json_object_filter_nulls([
#("checklist_message", json.nullable(checklist_tasks_done.checklist_message, encode_message)),
#("marked_as_done_task_ids", json.nullable(checklist_tasks_done.marked_as_done_task_ids, json.array(_, json.int))),
#("marked_as_not_done_task_ids", json.nullable(checklist_tasks_done.marked_as_not_done_task_ids, json.array(_, json.int))),
  ])
}

pub fn encode_checklist_tasks_added(checklist_tasks_added: ChecklistTasksAdded) -> Json {
json_object_filter_nulls([
#("checklist_message", json.nullable(checklist_tasks_added.checklist_message, encode_message)),
#("tasks", json.array(_, encode_checklist_task)(checklist_tasks_added.tasks)),
  ])
}
...
#("horizontal_accuracy", json.nullable(location.horizontal_accuracy, json.float)),
#("live_period", json.nullable(location.live_period, json.int)),
#("heading", json.nullable(location.heading, json.int)),
#("proximity_alert_radius", json.nullable(location.proximity_alert_radius, json.int)),
  ])
}
...
pub fn encode_proximity_alert_triggered(proximity_alert_triggered: ProximityAlertTriggered) -> Json {
json_object_filter_nulls([
...
pub fn encode_message_auto_delete_timer_changed(message_auto_delete_timer_changed: MessageAutoDeleteTimerChanged) -> Json {
json_object_filter_nulls([
#("message_auto_delete_time", json.int(message_auto_delete_timer_changed.message_auto_delete_time)),
  ])
}

pub fn encode_managed_bot_created(managed_bot_created: ManagedBotCreated) -> Json {
json_object_filter_nulls([
#("bot", encode_user(managed_bot_created.bot)),
  ])
}

pub fn encode_managed_bot_updated(managed_bot_updated: ManagedBotUpdated) -> Json {
json_object_filter_nulls([
...
json_object_filter_nulls([
#("poll_message", json.nullable(poll_option_added.poll_message, encode_maybe_inaccessible_message)),
#("option_persistent_id", json.string(poll_option_added.option_persistent_id)),
#("option_text", json.string(poll_option_added.option_text)),
#("option_text_entities", json.nullable(poll_option_added.option_text_entities, json.array(_, encode_message_entity))),
  ])
}

pub fn encode_poll_option_deleted(poll_option_deleted: PollOptionDeleted) -> Json {
json_object_filter_nulls([
#("poll_message", json.nullable(poll_option_deleted.poll_message, encode_maybe_inaccessible_message)),
#("option_persistent_id", json.string(poll_option_deleted.option_persistent_id)),
#("option_text", json.string(poll_option_deleted.option_text)),
#("option_text_entities", json.nullable(poll_option_deleted.option_text_entities, json.array(_, encode_message_entity))),
  ])
}
...
pub fn encode_background_fill_solid(background_fill_solid: BackgroundFillSolid) -> Json {
json_object_filter_nulls([
...
pub fn encode_background_fill_gradient(background_fill_gradient: BackgroundFillGradient) -> Json {
json_object_filter_nulls([
...
pub fn encode_background_fill_freeform_gradient(background_fill_freeform_gradient: BackgroundFillFreeformGradient) -> Json {
json_object_filter_nulls([
#("type", json.string(background_fill_freeform_gradient.type_)),
#("colors", json.array(_, json.int)(background_fill_freeform_gradient.colors)),
  ])
}

pub fn encode_background_type_fill(background_type_fill: BackgroundTypeFill) -> Json {
json_object_filter_nulls([
...
pub fn encode_background_type_wallpaper(background_type_wallpaper: BackgroundTypeWallpaper) -> Json {
json_object_filter_nulls([
#("type", json.string(background_type_wallpaper.type_)),
#("document", encode_document(background_type_wallpaper.document)),
#("dark_theme_dimming", json.int(background_type_wallpaper.dark_theme_dimming)),
#("is_blurred", json.nullable(background_type_wallpaper.is_blurred, json.bool)),
#("is_moving", json.nullable(background_type_wallpaper.is_moving, json.bool)),
  ])
}

pub fn encode_background_type_pattern(background_type_pattern: BackgroundTypePattern) -> Json {
json_object_filter_nulls([
...
#("is_inverted", json.nullable(background_type_pattern.is_inverted, json.bool)),
#("is_moving", json.nullable(background_type_pattern.is_moving, json.bool)),
  ])
}

pub fn encode_background_type_chat_theme(background_type_chat_theme: BackgroundTypeChatTheme) -> Json {
json_object_filter_nulls([
...
pub fn encode_forum_topic_created(forum_topic_created: ForumTopicCreated) -> Json {
json_object_filter_nulls([
#("name", json.string(forum_topic_created.name)),
#("icon_color", json.int(forum_topic_created.icon_color)),
#("icon_custom_emoji_id", json.nullable(forum_topic_created.icon_custom_emoji_id, json.string)),
#("is_name_implicit", json.nullable(forum_topic_created.is_name_implicit, json.bool)),
  ])
}
...
#("icon_custom_emoji_id", json.nullable(forum_topic_edited.icon_custom_emoji_id, json.string)),
  ])
}

pub fn encode_forum_topic_reopened(_forum_topic_reopened: ForumTopicReopened) -> Json {
json_object_filter_nulls([])
}

pub fn encode_general_forum_topic_hidden(_general_forum_topic_hidden: GeneralForumTopicHidden) -> Json {
json_object_filter_nulls([])
}

pub fn encode_general_forum_topic_unhidden(_general_forum_topic_unhidden: GeneralForumTopicUnhidden) -> Json {
json_object_filter_nulls([])
}
...
#("photo", json.nullable(shared_user.photo, json.array(_, encode_photo_size))),
  ])
}
...
#("photo", json.nullable(chat_shared.photo, json.array(_, encode_photo_size))),
  ])
}

pub fn encode_write_access_allowed(write_access_allowed: WriteAccessAllowed) -> Json {
json_object_filter_nulls([
#("from_request", json.nullable(write_access_allowed.from_request, json.bool)),
#("web_app_name", json.nullable(write_access_allowed.web_app_name, json.string)),
#("from_attachment_menu", json.nullable(write_access_allowed.from_attachment_menu, json.bool)),
  ])
}

pub fn encode_video_chat_scheduled(video_chat_scheduled: VideoChatScheduled) -> Json {
json_object_filter_nulls([
...
pub fn encode_video_chat_participants_invited(video_chat_participants_invited: VideoChatParticipantsInvited) -> Json {
json_object_filter_nulls([
#("users", json.array(_, encode_user)(video_chat_participants_invited.users)),
  ])
}

pub fn encode_paid_message_price_changed(paid_message_price_changed: PaidMessagePriceChanged) -> Json {
json_object_filter_nulls([
#("paid_message_star_count", json.int(paid_message_price_changed.paid_message_star_count)),
  ])
}

pub fn encode_direct_message_price_changed(direct_message_price_changed: DirectMessagePriceChanged) -> Json {
json_object_filter_nulls([
#("are_direct_messages_enabled", json.bool(direct_message_price_changed.are_direct_messages_enabled)),
#("direct_message_star_count", json.nullable(direct_message_price_changed.direct_message_star_count, json.int)),
  ])
}

pub fn encode_suggested_post_approved(suggested_post_approved: SuggestedPostApproved) -> Json {
json_object_filter_nulls([
#("suggested_post_message", json.nullable(suggested_post_approved.suggested_post_message, encode_message)),
#("price", json.nullable(suggested_post_approved.price, encode_suggested_post_price)),
#("send_date", json.int(suggested_post_approved.send_date)),
  ])
}

pub fn encode_suggested_post_approval_failed(suggested_post_approval_failed: SuggestedPostApprovalFailed) -> Json {
json_object_filter_nulls([
#("suggested_post_message", json.nullable(suggested_post_approval_failed.suggested_post_message, encode_message)),
#("price", encode_suggested_post_price(suggested_post_approval_failed.price)),
  ])
}

pub fn encode_suggested_post_declined(suggested_post_declined: SuggestedPostDeclined) -> Json {
json_object_filter_nulls([
#("suggested_post_message", json.nullable(suggested_post_declined.suggested_post_message, encode_message)),
#("comment", json.nullable(suggested_post_declined.comment, json.string)),
  ])
}

pub fn encode_suggested_post_paid(suggested_post_paid: SuggestedPostPaid) -> Json {
json_object_filter_nulls([
#("suggested_post_message", json.nullable(suggested_post_paid.suggested_post_message, encode_message)),
#("currency", json.string(suggested_post_paid.currency)),
#("amount", json.nullable(suggested_post_paid.amount, json.int)),
#("star_amount", json.nullable(suggested_post_paid.star_amount, encode_star_amount)),
  ])
}

pub fn encode_suggested_post_refunded(suggested_post_refunded: SuggestedPostRefunded) -> Json {
json_object_filter_nulls([
#("suggested_post_message", json.nullable(suggested_post_refunded.suggested_post_message, encode_message)),
...
json_object_filter_nulls([
#("prize_star_count", json.nullable(giveaway_created.prize_star_count, json.int)),
  ])
}
...
#("has_public_winners", json.nullable(giveaway.has_public_winners, json.bool)),
#("prize_description", json.nullable(giveaway.prize_description, json.string)),
#("country_codes", json.nullable(giveaway.country_codes, json.array(_, json.string))),
#("prize_star_count", json.nullable(giveaway.prize_star_count, json.int)),
#("premium_subscription_month_count", json.nullable(giveaway.premium_subscription_month_count, json.int)),
  ])
}
...
#("winners_selection_date", json.int(giveaway_winners.winners_selection_date)),
#("winner_count", json.int(giveaway_winners.winner_count)),
#("winners", json.array(_, encode_user)(giveaway_winners.winners)),
#("additional_chat_count", json.nullable(giveaway_winners.additional_chat_count, json.int)),
#("prize_star_count", json.nullable(giveaway_winners.prize_star_count, json.int)),
#("premium_subscription_month_count", json.nullable(giveaway_winners.premium_subscription_month_count, json.int)),
#("unclaimed_prize_count", json.nullable(giveaway_winners.unclaimed_prize_count, json.int)),
#("only_new_members", json.nullable(giveaway_winners.only_new_members, json.bool)),
#("was_refunded", json.nullable(giveaway_winners.was_refunded, json.bool)),
#("prize_description", json.nullable(giveaway_winners.prize_description, json.string)),
  ])
}
...
#("unclaimed_prize_count", json.nullable(giveaway_completed.unclaimed_prize_count, json.int)),
#("giveaway_message", json.nullable(giveaway_completed.giveaway_message, encode_message)),
#("is_star_giveaway", json.nullable(giveaway_completed.is_star_giveaway, json.bool)),
  ])
}

pub fn encode_link_preview_options(link_preview_options: LinkPreviewOptions) -> Json {
json_object_filter_nulls([
...
#("prefer_small_media", json.nullable(link_preview_options.prefer_small_media, json.bool)),
#("prefer_large_media", json.nullable(link_preview_options.prefer_large_media, json.bool)),
#("show_above_text", json.nullable(link_preview_options.show_above_text, json.bool)),
  ])
}

pub fn encode_suggested_post_price(suggested_post_price: SuggestedPostPrice) -> Json {
json_object_filter_nulls([
...
pub fn encode_suggested_post_info(suggested_post_info: SuggestedPostInfo) -> Json {
json_object_filter_nulls([
#("state", json.string(suggested_post_info.state)),
#("price", json.nullable(suggested_post_info.price, encode_suggested_post_price)),
#("send_date", json.nullable(suggested_post_info.send_date, json.int)),
  ])
}

pub fn encode_suggested_post_parameters(suggested_post_parameters: SuggestedPostParameters) -> Json {
json_object_filter_nulls([
#("price", json.nullable(suggested_post_parameters.price, encode_suggested_post_price)),
#("send_date", json.nullable(suggested_post_parameters.send_date, json.int)),
  ])
}

pub fn encode_direct_messages_topic(direct_messages_topic: DirectMessagesTopic) -> Json {
json_object_filter_nulls([
...
pub fn encode_user_profile_photos(user_profile_photos: UserProfilePhotos) -> Json {
json_object_filter_nulls([
#("total_count", json.int(user_profile_photos.total_count)),
#("photos", fn(outer_list) { json.array(outer_list, fn(inner_list) { json.array(inner_list, encode_photo_size)})}(user_profile_photos.photos)),
  ])
}

pub fn encode_user_profile_audios(user_profile_audios: UserProfileAudios) -> Json {
json_object_filter_nulls([
...
pub fn encode_reply_keyboard_markup(reply_keyboard_markup: ReplyKeyboardMarkup) -> Json {
json_object_filter_nulls([
#("keyboard", fn(outer_list) { json.array(outer_list, fn(inner_list) { json.array(inner_list, encode_keyboard_button)})}(reply_keyboard_markup.keyboard)),
#("is_persistent", json.nullable(reply_keyboard_markup.is_persistent, json.bool)),
#("resize_keyboard", json.nullable(reply_keyboard_markup.resize_keyboard, json.bool)),
#("one_time_keyboard", json.nullable(reply_keyboard_markup.one_time_keyboard, json.bool)),
#("input_field_placeholder", json.nullable(reply_keyboard_markup.input_field_placeholder, json.string)),
...
#("icon_custom_emoji_id", json.nullable(keyboard_button.icon_custom_emoji_id, json.string)),
#("style", json.nullable(keyboard_button.style, json.string)),
#("request_users", json.nullable(keyboard_button.request_users, encode_keyboard_button_request_users)),
#("request_chat", json.nullable(keyboard_button.request_chat, encode_keyboard_button_request_chat)),
#("request_managed_bot", json.nullable(keyboard_button.request_managed_bot, encode_keyboard_button_request_managed_bot)),
#("request_contact", json.nullable(keyboard_button.request_contact, json.bool)),
#("request_location", json.nullable(keyboard_button.request_location, json.bool)),
#("request_poll", json.nullable(keyboard_button.request_poll, encode_keyboard_button_poll_type)),
#("web_app", json.nullable(keyboard_button.web_app, encode_web_app_info)),
  ])
}

pub fn encode_keyboard_button_request_users(keyboard_button_request_users: KeyboardButtonRequestUsers) -> Json {
json_object_filter_nulls([
#("request_id", json.int(keyboard_button_request_users.request_id)),
#("user_is_bot", json.nullable(keyboard_button_request_users.user_is_bot, json.bool)),
#("user_is_premium", json.nullable(keyboard_button_request_users.user_is_premium, json.bool)),
#("max_quantity", json.nullable(keyboard_button_request_users.max_quantity, json.int)),
#("request_name", json.nullable(keyboard_button_request_users.request_name, json.bool)),
#("request_username", json.nullable(keyboard_button_request_users.request_username, json.bool)),
#("request_photo", json.nullable(keyboard_button_request_users.request_photo, json.bool)),
  ])
}

pub fn encode_keyboard_button_request_chat(keyboard_button_request_chat: KeyboardButtonRequestChat) -> Json {
json_object_filter_nulls([
#("request_id", json.int(keyboard_button_request_chat.request_id)),
#("chat_is_channel", json.bool(keyboard_button_request_chat.chat_is_channel)),
#("chat_is_forum", json.nullable(keyboard_button_request_chat.chat_is_forum, json.bool)),
#("chat_has_username", json.nullable(keyboard_button_request_chat.chat_has_username, json.bool)),
#("chat_is_created", json.nullable(keyboard_button_request_chat.chat_is_created, json.bool)),
#("user_administrator_rights", json.nullable(keyboard_button_request_chat.user_administrator_rights, encode_chat_administrator_rights)),
#("bot_administrator_rights", json.nullable(keyboard_button_request_chat.bot_administrator_rights, encode_chat_administrator_rights)),
#("bot_is_member", json.nullable(keyboard_button_request_chat.bot_is_member, json.bool)),
#("request_title", json.nullable(keyboard_button_request_chat.request_title, json.bool)),
#("request_username", json.nullable(keyboard_button_request_chat.request_username, json.bool)),
#("request_photo", json.nullable(keyboard_button_request_chat.request_photo, json.bool)),
  ])
}

pub fn encode_keyboard_button_request_managed_bot(keyboard_button_request_managed_bot: KeyboardButtonRequestManagedBot) -> Json {
json_object_filter_nulls([
#("request_id", json.int(keyboard_button_request_managed_bot.request_id)),
#("suggested_name", json.nullable(keyboard_button_request_managed_bot.suggested_name, json.string)),
#("suggested_username", json.nullable(keyboard_button_request_managed_bot.suggested_username, json.string)),
  ])
}

pub fn encode_keyboard_button_poll_type(keyboard_button_poll_type: KeyboardButtonPollType) -> Json {
json_object_filter_nulls([
#("type", json.nullable(keyboard_button_poll_type.type_, json.string)),
  ])
}

pub fn encode_reply_keyboard_remove(reply_keyboard_remove: ReplyKeyboardRemove) -> Json {
json_object_filter_nulls([
...
pub fn encode_inline_keyboard_markup(inline_keyboard_markup: InlineKeyboardMarkup) -> Json {
json_object_filter_nulls([
#("inline_keyboard", fn(outer_list) { json.array(outer_list, fn(inner_list) { json.array(inner_list, encode_inline_keyboard_button)})}(inline_keyboard_markup.inline_keyboard)),
  ])
}

pub fn encode_inline_keyboard_button(inline_keyboard_button: InlineKeyboardButton) -> Json {
json_object_filter_nulls([
#("text", json.string(inline_keyboard_button.text)),
#("icon_custom_emoji_id", json.nullable(inline_keyboard_button.icon_custom_emoji_id, json.string)),
#("style", json.nullable(inline_keyboard_button.style, json.string)),
#("url", json.nullable(inline_keyboard_button.url, json.string)),
#("callback_data", json.nullable(inline_keyboard_button.callback_data, json.string)),
#("web_app", json.nullable(inline_keyboard_button.web_app, encode_web_app_info)),
#("login_url", json.nullable(inline_keyboard_button.login_url, encode_login_url)),
#("switch_inline_query", json.nullable(inline_keyboard_button.switch_inline_query, json.string)),
#("switch_inline_query_current_chat", json.nullable(inline_keyboard_button.switch_inline_query_current_chat, json.string)),
#("switch_inline_query_chosen_chat", json.nullable(inline_keyboard_button.switch_inline_query_chosen_chat, encode_switch_inline_query_chosen_chat)),
#("copy_text", json.nullable(inline_keyboard_button.copy_text, encode_copy_text_button)),
#("callback_game", json.nullable(inline_keyboard_button.callback_game, encode_callback_game)),
...
#("request_write_access", json.nullable(login_url.request_write_access, json.bool)),
  ])
}

pub fn encode_switch_inline_query_chosen_chat(switch_inline_query_chosen_chat: SwitchInlineQueryChosenChat) -> Json {
json_object_filter_nulls([
#("query", json.nullable(switch_inline_query_chosen_chat.query, json.string)),
#("allow_user_chats", json.nullable(switch_inline_query_chosen_chat.allow_user_chats, json.bool)),
#("allow_bot_chats", json.nullable(switch_inline_query_chosen_chat.allow_bot_chats, json.bool)),
#("allow_group_chats", json.nullable(switch_inline_query_chosen_chat.allow_group_chats, json.bool)),
#("allow_channel_chats", json.nullable(switch_inline_query_chosen_chat.allow_channel_chats, json.bool)),
  ])
}
...
#("message", json.nullable(callback_query.message, encode_maybe_inaccessible_message)),
#("inline_message_id", json.nullable(callback_query.inline_message_id, json.string)),
#("chat_instance", json.string(callback_query.chat_instance)),
#("data", json.nullable(callback_query.data, json.string)),
#("game_short_name", json.nullable(callback_query.game_short_name, json.string)),
  ])
}
...
#("input_field_placeholder", json.nullable(force_reply.input_field_placeholder, json.string)),
...
#("pending_join_request_count", json.nullable(chat_invite_link.pending_join_request_count, json.int)),
#("subscription_period", json.nullable(chat_invite_link.subscription_period, json.int)),
#("subscription_price", json.nullable(chat_invite_link.subscription_price, json.int)),
  ])
}

pub fn encode_chat_administrator_rights(chat_administrator_rights: ChatAdministratorRights) -> Json {
json_object_filter_nulls([
...
#("can_delete_messages", json.bool(chat_administrator_rights.can_delete_messages)),
#("can_manage_video_chats", json.bool(chat_administrator_rights.can_manage_video_chats)),
#("can_restrict_members", json.bool(chat_administrator_rights.can_restrict_members)),
#("can_promote_members", json.bool(chat_administrator_rights.can_promote_members)),
...
#("can_delete_stories", json.bool(chat_administrator_rights.can_delete_stories)),
#("can_post_messages", json.nullable(chat_administrator_rights.can_post_messages, json.bool)),
#("can_edit_messages", json.nullable(chat_administrator_rights.can_edit_messages, json.bool)),
#("can_pin_messages", json.nullable(chat_administrator_rights.can_pin_messages, json.bool)),
#("can_manage_topics", json.nullable(chat_administrator_rights.can_manage_topics, json.bool)),
#("can_manage_direct_messages", json.nullable(chat_administrator_rights.can_manage_direct_messages, json.bool)),
#("can_manage_tags", json.nullable(chat_administrator_rights.can_manage_tags, json.bool)),
  ])
}

pub fn encode_chat_member_updated(chat_member_updated: ChatMemberUpdated) -> Json {
json_object_filter_nulls([
#("chat", encode_chat(chat_member_updated.chat)),
#("from", encode_user(chat_member_updated.from)),
#("date", json.int(chat_member_updated.date)),
#("old_chat_member", encode_chat_member(chat_member_updated.old_chat_member)),
#("new_chat_member", encode_chat_member(chat_member_updated.new_chat_member)),
#("invite_link", json.nullable(chat_member_updated.invite_link, encode_chat_invite_link)),
#("via_join_request", json.nullable(chat_member_updated.via_join_request, json.bool)),
#("via_chat_folder_invite_link", json.nullable(chat_member_updated.via_chat_folder_invite_link, json.bool)),
  ])
}
...
#("custom_title", json.nullable(chat_member_owner.custom_title, json.string)),
  ])
}

pub fn encode_chat_member_administrator(chat_member_administrator: ChatMemberAdministrator) -> Json {
json_object_filter_nulls([
...
#("can_delete_messages", json.bool(chat_member_administrator.can_delete_messages)),
#("can_manage_video_chats", json.bool(chat_member_administrator.can_manage_video_chats)),
#("can_restrict_members", json.bool(chat_member_administrator.can_restrict_members)),
#("can_promote_members", json.bool(chat_member_administrator.can_promote_members)),
...
#("can_delete_stories", json.bool(chat_member_administrator.can_delete_stories)),
#("can_post_messages", json.nullable(chat_member_administrator.can_post_messages, json.bool)),
#("can_edit_messages", json.nullable(chat_member_administrator.can_edit_messages, json.bool)),
#("can_pin_messages", json.nullable(chat_member_administrator.can_pin_messages, json.bool)),
#("can_manage_topics", json.nullable(chat_member_administrator.can_manage_topics, json.bool)),
#("can_manage_direct_messages", json.nullable(chat_member_administrator.can_manage_direct_messages, json.bool)),
#("can_manage_tags", json.nullable(chat_member_administrator.can_manage_tags, json.bool)),
#("custom_title", json.nullable(chat_member_administrator.custom_title, json.string)),
  ])
}
...
pub fn encode_chat_member_restricted(chat_member_restricted: ChatMemberRestricted) -> Json {
json_object_filter_nulls([
...
#("can_send_documents", json.bool(chat_member_restricted.can_send_documents)),
...
#("can_send_video_notes", json.bool(chat_member_restricted.can_send_video_notes)),
#("can_send_voice_notes", json.bool(chat_member_restricted.can_send_voice_notes)),
...
#("invite_link", json.nullable(chat_join_request.invite_link, encode_chat_invite_link)),
  ])
}

pub fn encode_chat_permissions(chat_permissions: ChatPermissions) -> Json {
json_object_filter_nulls([
#("can_send_messages", json.nullable(chat_permissions.can_send_messages, json.bool)),
#("can_send_audios", json.nullable(chat_permissions.can_send_audios, json.bool)),
#("can_send_documents", json.nullable(chat_permissions.can_send_documents, json.bool)),
#("can_send_photos", json.nullable(chat_permissions.can_send_photos, json.bool)),
#("can_send_videos", json.nullable(chat_permissions.can_send_videos, json.bool)),
#("can_send_video_notes", json.nullable(chat_permissions.can_send_video_notes, json.bool)),
#("can_send_voice_notes", json.nullable(chat_permissions.can_send_voice_notes, json.bool)),
...
#("can_pin_messages", json.nullable(chat_permissions.can_pin_messages, json.bool)),
#("can_manage_topics", json.nullable(chat_permissions.can_manage_topics, json.bool)),
  ])
}
...
pub fn encode_business_opening_hours_interval(business_opening_hours_interval: BusinessOpeningHoursInterval) -> Json {
json_object_filter_nulls([
#("opening_minute", json.int(business_opening_hours_interval.opening_minute)),
#("closing_minute", json.int(business_opening_hours_interval.closing_minute)),
  ])
}

pub fn encode_business_opening_hours(business_opening_hours: BusinessOpeningHours) -> Json {
json_object_filter_nulls([
#("time_zone_name", json.string(business_opening_hours.time_zone_name)),
#("opening_hours", json.array(_, encode_business_opening_hours_interval)(business_opening_hours.opening_hours)),
  ])
}
...
#("next_level_rating", json.nullable(user_rating.next_level_rating, json.int)),
  ])
}

pub fn encode_story_area_position(story_area_position: StoryAreaPosition) -> Json {
json_object_filter_nulls([
...
#("corner_radius_percentage", json.float(story_area_position.corner_radius_percentage)),
  ])
}
...
#("address", json.nullable(story_area_type.address, encode_location_address)),
  ])
}

pub fn encode_story_area_type_location(story_area_type_location: StoryAreaTypeLocation) -> Json {
json_object_filter_nulls([
...
#("address", json.nullable(story_area_type_location.address, encode_location_address)),
  ])
}

pub fn encode_story_area_type_suggested_reaction(story_area_type_suggested_reaction: StoryAreaTypeSuggestedReaction) -> Json {
json_object_filter_nulls([
#("type", json.string(story_area_type_suggested_reaction.type_)),
#("reaction_type", encode_reaction_type(story_area_type_suggested_reaction.reaction_type)),
#("is_dark", json.nullable(story_area_type_suggested_reaction.is_dark, json.bool)),
#("is_flipped", json.nullable(story_area_type_suggested_reaction.is_flipped, json.bool)),
  ])
}

pub fn encode_story_area_type_link(story_area_type_link: StoryAreaTypeLink) -> Json {
json_object_filter_nulls([
...
pub fn encode_story_area_type_weather(story_area_type_weather: StoryAreaTypeWeather) -> Json {
json_object_filter_nulls([
...
pub fn encode_story_area_type_unique_gift(story_area_type_unique_gift: StoryAreaTypeUniqueGift) -> Json {
json_object_filter_nulls([
...
pub fn encode_reaction_type_emoji(reaction_type_emoji: ReactionTypeEmoji) -> Json {
json_object_filter_nulls([
...
pub fn encode_reaction_type_custom_emoji(reaction_type_custom_emoji: ReactionTypeCustomEmoji) -> Json {
json_object_filter_nulls([
#("type", json.string(reaction_type_custom_emoji.type_)),
#("custom_emoji_id", json.string(reaction_type_custom_emoji.custom_emoji_id)),
  ])
}
...
pub fn encode_message_reaction_updated(message_reaction_updated: MessageReactionUpdated) -> Json {
json_object_filter_nulls([
...
#("actor_chat", json.nullable(message_reaction_updated.actor_chat, encode_chat)),
#("date", json.int(message_reaction_updated.date)),
#("old_reaction", json.array(_, encode_reaction_type)(message_reaction_updated.old_reaction)),
#("new_reaction", json.array(_, encode_reaction_type)(message_reaction_updated.new_reaction)),
  ])
}

pub fn encode_message_reaction_count_updated(message_reaction_count_updated: MessageReactionCountUpdated) -> Json {
json_object_filter_nulls([
...
#("reactions", json.array(_, encode_reaction_count)(message_reaction_count_updated.reactions)),
  ])
}
...
#("icon_custom_emoji_id", json.nullable(forum_topic.icon_custom_emoji_id, json.string)),
#("is_name_implicit", json.nullable(forum_topic.is_name_implicit, json.bool)),
  ])
}
...
#("personal_total_count", json.nullable(gift.personal_total_count, json.int)),
#("personal_remaining_count", json.nullable(gift.personal_remaining_count, json.int)),
#("background", json.nullable(gift.background, encode_gift_background)),
#("unique_gift_variant_count", json.nullable(gift.unique_gift_variant_count, json.int)),
...
pub fn encode_unique_gift_backdrop_colors(unique_gift_backdrop_colors: UniqueGiftBackdropColors) -> Json {
json_object_filter_nulls([
...
pub fn encode_unique_gift_backdrop(unique_gift_backdrop: UniqueGiftBackdrop) -> Json {
json_object_filter_nulls([
...
json_object_filter_nulls([
#("model_custom_emoji_id", json.string(unique_gift_colors.model_custom_emoji_id)),
#("symbol_custom_emoji_id", json.string(unique_gift_colors.symbol_custom_emoji_id)),
#("light_theme_main_color", json.int(unique_gift_colors.light_theme_main_color)),
#("light_theme_other_colors", json.array(_, json.int)(unique_gift_colors.light_theme_other_colors)),
#("dark_theme_main_color", json.int(unique_gift_colors.dark_theme_main_color)),
#("dark_theme_other_colors", json.array(_, json.int)(unique_gift_colors.dark_theme_other_colors)),
  ])
}
...
#("is_from_blockchain", json.nullable(unique_gift.is_from_blockchain, json.bool)),
...
#("convert_star_count", json.nullable(gift_info.convert_star_count, json.int)),
#("prepaid_upgrade_star_count", json.nullable(gift_info.prepaid_upgrade_star_count, json.int)),
#("is_upgrade_separate", json.nullable(gift_info.is_upgrade_separate, json.bool)),
#("can_be_upgraded", json.nullable(gift_info.can_be_upgraded, json.bool)),
#("text", json.nullable(gift_info.text, json.string)),
#("entities", json.nullable(gift_info.entities, json.array(_, encode_message_entity))),
#("is_private", json.nullable(gift_info.is_private, json.bool)),
#("unique_gift_number", json.nullable(gift_info.unique_gift_number, json.int)),
  ])
}
...
#("last_resale_currency", json.nullable(unique_gift_info.last_resale_currency, json.string)),
#("last_resale_amount", json.nullable(unique_gift_info.last_resale_amount, json.int)),
#("owned_gift_id", json.nullable(unique_gift_info.owned_gift_id, json.string)),
#("transfer_star_count", json.nullable(unique_gift_info.transfer_star_count, json.int)),
#("next_transfer_date", json.nullable(unique_gift_info.next_transfer_date, json.int)),
  ])
}
...
#("entities", json.nullable(owned_gift.entities, json.array(_, encode_message_entity))),
...
#("convert_star_count", json.nullable(owned_gift.convert_star_count, json.int)),
#("prepaid_upgrade_star_count", json.nullable(owned_gift.prepaid_upgrade_star_count, json.int)),
#("is_upgrade_separate", json.nullable(owned_gift.is_upgrade_separate, json.bool)),
#("unique_gift_number", json.nullable(owned_gift.unique_gift_number, json.int)),
  ])
}
...
#("owned_gift_id", json.nullable(owned_gift_regular.owned_gift_id, json.string)),
...
#("entities", json.nullable(owned_gift_regular.entities, json.array(_, encode_message_entity))),
...
#("can_be_upgraded", json.nullable(owned_gift_regular.can_be_upgraded, json.bool)),
#("was_refunded", json.nullable(owned_gift_regular.was_refunded, json.bool)),
#("convert_star_count", json.nullable(owned_gift_regular.convert_star_count, json.int)),
#("prepaid_upgrade_star_count", json.nullable(owned_gift_regular.prepaid_upgrade_star_count, json.int)),
#("is_upgrade_separate", json.nullable(owned_gift_regular.is_upgrade_separate, json.bool)),
#("unique_gift_number", json.nullable(owned_gift_regular.unique_gift_number, json.int)),
  ])
}
...
#("owned_gift_id", json.nullable(owned_gift_unique.owned_gift_id, json.string)),
...
#("can_be_transferred", json.nullable(owned_gift_unique.can_be_transferred, json.bool)),
#("transfer_star_count", json.nullable(owned_gift_unique.transfer_star_count, json.int)),
#("next_transfer_date", json.nullable(owned_gift_unique.next_transfer_date, json.int)),
  ])
}
...
#("premium_subscription", json.bool(accepted_gift_types.premium_subscription)),
...
pub fn encode_bot_command_scope_default(bot_command_scope_default: BotCommandScopeDefault) -> Json {
json_object_filter_nulls([
#("type", json.string(bot_command_scope_default.type_)),
  ])
}

pub fn encode_bot_command_scope_all_private_chats(bot_command_scope_all_private_chats: BotCommandScopeAllPrivateChats) -> Json {
json_object_filter_nulls([
#("type", json.string(bot_command_scope_all_private_chats.type_)),
  ])
}

pub fn encode_bot_command_scope_all_group_chats(bot_command_scope_all_group_chats: BotCommandScopeAllGroupChats) -> Json {
json_object_filter_nulls([
#("type", json.string(bot_command_scope_all_group_chats.type_)),
  ])
}

pub fn encode_bot_command_scope_all_chat_administrators(bot_command_scope_all_chat_administrators: BotCommandScopeAllChatAdministrators) -> Json {
json_object_filter_nulls([
#("type", json.string(bot_command_scope_all_chat_administrators.type_)),
  ])
}

pub fn encode_bot_command_scope_chat(bot_command_scope_chat: BotCommandScopeChat) -> Json {
json_object_filter_nulls([
...
pub fn encode_bot_command_scope_chat_administrators(bot_command_scope_chat_administrators: BotCommandScopeChatAdministrators) -> Json {
json_object_filter_nulls([
#("type", json.string(bot_command_scope_chat_administrators.type_)),
#("chat_id", encode_int_or_string(bot_command_scope_chat_administrators.chat_id)),
  ])
}

pub fn encode_bot_command_scope_chat_member(bot_command_scope_chat_member: BotCommandScopeChatMember) -> Json {
json_object_filter_nulls([
...
pub fn encode_bot_short_description(bot_short_description: BotShortDescription) -> Json {
json_object_filter_nulls([
#("short_description", json.string(bot_short_description.short_description)),
  ])
}

pub fn encode_menu_button_commands(menu_button_commands: MenuButtonCommands) -> Json {
json_object_filter_nulls([
...
pub fn encode_menu_button_default(menu_button_default: MenuButtonDefault) -> Json {
json_object_filter_nulls([
#("type", json.string(menu_button_default.type_)),
  ])
}

pub fn encode_chat_boost_source_premium(chat_boost_source_premium: ChatBoostSourcePremium) -> Json {
json_object_filter_nulls([
...
pub fn encode_chat_boost_source_gift_code(chat_boost_source_gift_code: ChatBoostSourceGiftCode) -> Json {
json_object_filter_nulls([
...
pub fn encode_chat_boost_source_giveaway(chat_boost_source_giveaway: ChatBoostSourceGiveaway) -> Json {
json_object_filter_nulls([
#("source", json.string(chat_boost_source_giveaway.source)),
#("giveaway_message_id", json.int(chat_boost_source_giveaway.giveaway_message_id)),
#("user", json.nullable(chat_boost_source_giveaway.user, encode_user)),
#("prize_star_count", json.nullable(chat_boost_source_giveaway.prize_star_count, json.int)),
#("is_unclaimed", json.nullable(chat_boost_source_giveaway.is_unclaimed, json.bool)),
  ])
}
...
pub fn encode_business_bot_rights(business_bot_rights: BusinessBotRights) -> Json {
json_object_filter_nulls([
#("can_reply", json.nullable(business_bot_rights.can_reply, json.bool)),
#("can_read_messages", json.nullable(business_bot_rights.can_read_messages, json.bool)),
#("can_delete_sent_messages", json.nullable(business_bot_rights.can_delete_sent_messages, json.bool)),
#("can_delete_all_messages", json.nullable(business_bot_rights.can_delete_all_messages, json.bool)),
#("can_edit_name", json.nullable(business_bot_rights.can_edit_name, json.bool)),
#("can_edit_bio", json.nullable(business_bot_rights.can_edit_bio, json.bool)),
#("can_edit_profile_photo", json.nullable(business_bot_rights.can_edit_profile_photo, json.bool)),
#("can_edit_username", json.nullable(business_bot_rights.can_edit_username, json.bool)),
#("can_change_gift_settings", json.nullable(business_bot_rights.can_change_gift_settings, json.bool)),
#("can_view_gifts_and_stars", json.nullable(business_bot_rights.can_view_gifts_and_stars, json.bool)),
#("can_convert_gifts_to_stars", json.nullable(business_bot_rights.can_convert_gifts_to_stars, json.bool)),
#("can_transfer_and_upgrade_gifts", json.nullable(business_bot_rights.can_transfer_and_upgrade_gifts, json.bool)),
#("can_transfer_stars", json.nullable(business_bot_rights.can_transfer_stars, json.bool)),
#("can_manage_stories", json.nullable(business_bot_rights.can_manage_stories, json.bool)),
  ])
}

pub fn encode_business_connection(business_connection: BusinessConnection) -> Json {
json_object_filter_nulls([
...
#("rights", json.nullable(business_connection.rights, encode_business_bot_rights)),
#("is_enabled", json.bool(business_connection.is_enabled)),
  ])
}

pub fn encode_business_messages_deleted(business_messages_deleted: BusinessMessagesDeleted) -> Json {
json_object_filter_nulls([
#("business_connection_id", json.string(business_messages_deleted.business_connection_id)),
#("chat", encode_chat(business_messages_deleted.chat)),
#("message_ids", json.array(_, json.int)(business_messages_deleted.message_ids)),
  ])
}

pub fn encode_sent_web_app_message(sent_web_app_message: SentWebAppMessage) -> Json {
json_object_filter_nulls([
#("inline_message_id", json.nullable(sent_web_app_message.inline_message_id, json.string)),
  ])
}
...
pub fn encode_prepared_keyboard_button(prepared_keyboard_button: PreparedKeyboardButton) -> Json {
json_object_filter_nulls([
#("id", json.string(prepared_keyboard_button.id)),
  ])
}

pub fn encode_response_parameters(response_parameters: ResponseParameters) -> Json {
json_object_filter_nulls([
...
pub fn encode_input_media_animation(input_media_animation: InputMediaAnimation) -> Json {
json_object_filter_nulls([
...
#("parse_mode", json.nullable(input_media_animation.parse_mode, json.string)),
#("caption_entities", json.nullable(input_media_animation.caption_entities, json.array(_, encode_message_entity))),
#("show_caption_above_media", json.nullable(input_media_animation.show_caption_above_media, json.bool)),
...
#("has_spoiler", json.nullable(input_media_animation.has_spoiler, json.bool)),
  ])
}
...
#("caption_entities", json.nullable(input_media_audio.caption_entities, json.array(_, encode_message_entity))),
...
pub fn encode_input_media_document(input_media_document: InputMediaDocument) -> Json {
json_object_filter_nulls([
...
pub fn encode_input_paid_media_photo(input_paid_media_photo: InputPaidMediaPhoto) -> Json {
json_object_filter_nulls([
...
pub fn encode_input_paid_media_video(input_paid_media_video: InputPaidMediaVideo) -> Json {
json_object_filter_nulls([
...
#("start_timestamp", json.nullable(input_paid_media_video.start_timestamp, json.int)),
...
#("supports_streaming", json.nullable(input_paid_media_video.supports_streaming, json.bool)),
  ])
}

pub fn encode_input_profile_photo_static(input_profile_photo_static: InputProfilePhotoStatic) -> Json {
json_object_filter_nulls([
...
pub fn encode_input_profile_photo_animated(input_profile_photo_animated: InputProfilePhotoAnimated) -> Json {
json_object_filter_nulls([
#("type", json.string(input_profile_photo_animated.type_)),
#("animation", json.string(input_profile_photo_animated.animation)),
#("main_frame_timestamp", json.nullable(input_profile_photo_animated.main_frame_timestamp, json.float)),
  ])
}

pub fn encode_input_story_content(input_story_content: InputStoryContent) -> Json {
json_object_filter_nulls([
...
pub fn encode_input_story_content_photo(input_story_content_photo: InputStoryContentPhoto) -> Json {
json_object_filter_nulls([
...
pub fn encode_input_story_content_video(input_story_content_video: InputStoryContentVideo) -> Json {
json_object_filter_nulls([
...
#("cover_frame_timestamp", json.nullable(input_story_content_video.cover_frame_timestamp, json.float)),
#("is_animation", json.nullable(input_story_content_video.is_animation, json.bool)),
  ])
}
...
#("premium_animation", json.nullable(sticker.premium_animation, encode_file)),
#("mask_position", json.nullable(sticker.mask_position, encode_mask_position)),
...
#("mask_position", json.nullable(input_sticker.mask_position, encode_mask_position)),
#("keywords", json.nullable(input_sticker.keywords, json.array(_, json.string))),
  ])
}
...
pub fn encode_inline_query_results_button(inline_query_results_button: InlineQueryResultsButton) -> Json {
json_object_filter_nulls([
#("text", json.string(inline_query_results_button.text)),
#("web_app", json.nullable(inline_query_results_button.web_app, encode_web_app_info)),
#("start_parameter", json.nullable(inline_query_results_button.start_parameter, json.string)),
  ])
}

pub fn encode_inline_query_result_article(inline_query_result_article: InlineQueryResultArticle) -> Json {
json_object_filter_nulls([
...
#("input_message_content", encode_input_message_content(inline_query_result_article.input_message_content)),
#("reply_markup", json.nullable(inline_query_result_article.reply_markup, encode_inline_keyboard_markup)),
#("url", json.nullable(inline_query_result_article.url, json.string)),
#("description", json.nullable(inline_query_result_article.description, json.string)),
#("thumbnail_url", json.nullable(inline_query_result_article.thumbnail_url, json.string)),
#("thumbnail_width", json.nullable(inline_query_result_article.thumbnail_width, json.int)),
#("thumbnail_height", json.nullable(inline_query_result_article.thumbnail_height, json.int)),
  ])
}

pub fn encode_inline_query_result_photo(inline_query_result_photo: InlineQueryResultPhoto) -> Json {
json_object_filter_nulls([
...
#("photo_width", json.nullable(inline_query_result_photo.photo_width, json.int)),
#("photo_height", json.nullable(inline_query_result_photo.photo_height, json.int)),
#("title", json.nullable(inline_query_result_photo.title, json.string)),
#("description", json.nullable(inline_query_result_photo.description, json.string)),
#("caption", json.nullable(inline_query_result_photo.caption, json.string)),
#("parse_mode", json.nullable(inline_query_result_photo.parse_mode, json.string)),
#("caption_entities", json.nullable(inline_query_result_photo.caption_entities, json.array(_, encode_message_entity))),
#("show_caption_above_media", json.nullable(inline_query_result_photo.show_caption_above_media, json.bool)),
#("reply_markup", json.nullable(inline_query_result_photo.reply_markup, encode_inline_keyboard_markup)),
#("input_message_content", json.nullable(inline_query_result_photo.input_message_content, encode_input_message_content)),
  ])
}

pub fn encode_inline_query_result_gif(inline_query_result_gif: InlineQueryResultGif) -> Json {
json_object_filter_nulls([
...
#("gif_duration", json.nullable(inline_query_result_gif.gif_duration, json.int)),
#("thumbnail_url", json.string(inline_query_result_gif.thumbnail_url)),
#("thumbnail_mime_type", json.nullable(inline_query_result_gif.thumbnail_mime_type, json.string)),
...
#("parse_mode", json.nullable(inline_query_result_gif.parse_mode, json.string)),
#("caption_entities", json.nullable(inline_query_result_gif.caption_entities, json.array(_, encode_message_entity))),
#("show_caption_above_media", json.nullable(inline_query_result_gif.show_caption_above_media, json.bool)),
#("reply_markup", json.nullable(inline_query_result_gif.reply_markup, encode_inline_keyboard_markup)),
#("input_message_content", json.nullable(inline_query_result_gif.input_message_content, encode_input_message_content)),
  ])
}

pub fn encode_inline_query_result_mpeg4_gif(inline_query_result_mpeg4_gif: InlineQueryResultMpeg4Gif) -> Json {
json_object_filter_nulls([
...
#("mpeg4_width", json.nullable(inline_query_result_mpeg4_gif.mpeg4_width, json.int)),
#("mpeg4_height", json.nullable(inline_query_result_mpeg4_gif.mpeg4_height, json.int)),
#("mpeg4_duration", json.nullable(inline_query_result_mpeg4_gif.mpeg4_duration, json.int)),
#("thumbnail_url", json.string(inline_query_result_mpeg4_gif.thumbnail_url)),
#("thumbnail_mime_type", json.nullable(inline_query_result_mpeg4_gif.thumbnail_mime_type, json.string)),
#("title", json.nullable(inline_query_result_mpeg4_gif.title, json.string)),
#("caption", json.nullable(inline_query_result_mpeg4_gif.caption, json.string)),
#("parse_mode", json.nullable(inline_query_result_mpeg4_gif.parse_mode, json.string)),
#("caption_entities", json.nullable(inline_query_result_mpeg4_gif.caption_entities, json.array(_, encode_message_entity))),
#("show_caption_above_media", json.nullable(inline_query_result_mpeg4_gif.show_caption_above_media, json.bool)),
#("reply_markup", json.nullable(inline_query_result_mpeg4_gif.reply_markup, encode_inline_keyboard_markup)),
#("input_message_content", json.nullable(inline_query_result_mpeg4_gif.input_message_content, encode_input_message_content)),
  ])
}

pub fn encode_inline_query_result_video(inline_query_result_video: InlineQueryResultVideo) -> Json {
json_object_filter_nulls([
...
#("parse_mode", json.nullable(inline_query_result_video.parse_mode, json.string)),
#("caption_entities", json.nullable(inline_query_result_video.caption_entities, json.array(_, encode_message_entity))),
#("show_caption_above_media", json.nullable(inline_query_result_video.show_caption_above_media, json.bool)),
#("video_width", json.nullable(inline_query_result_video.video_width, json.int)),
#("video_height", json.nullable(inline_query_result_video.video_height, json.int)),
#("video_duration", json.nullable(inline_query_result_video.video_duration, json.int)),
#("description", json.nullable(inline_query_result_video.description, json.string)),
#("reply_markup", json.nullable(inline_query_result_video.reply_markup, encode_inline_keyboard_markup)),
#("input_message_content", json.nullable(inline_query_result_video.input_message_content, encode_input_message_content)),
  ])
}

pub fn encode_inline_query_result_audio(inline_query_result_audio: InlineQueryResultAudio) -> Json {
json_object_filter_nulls([
...
#("parse_mode", json.nullable(inline_query_result_audio.parse_mode, json.string)),
#("caption_entities", json.nullable(inline_query_result_audio.caption_entities, json.array(_, encode_message_entity))),
#("performer", json.nullable(inline_query_result_audio.performer, json.string)),
#("audio_duration", json.nullable(inline_query_result_audio.audio_duration, json.int)),
#("reply_markup", json.nullable(inline_query_result_audio.reply_markup, encode_inline_keyboard_markup)),
#("input_message_content", json.nullable(inline_query_result_audio.input_message_content, encode_input_message_content)),
  ])
}

pub fn encode_inline_query_result_voice(inline_query_result_voice: InlineQueryResultVoice) -> Json {
json_object_filter_nulls([
...
#("parse_mode", json.nullable(inline_query_result_voice.parse_mode, json.string)),
#("caption_entities", json.nullable(inline_query_result_voice.caption_entities, json.array(_, encode_message_entity))),
#("voice_duration", json.nullable(inline_query_result_voice.voice_duration, json.int)),
#("reply_markup", json.nullable(inline_query_result_voice.reply_markup, encode_inline_keyboard_markup)),
#("input_message_content", json.nullable(inline_query_result_voice.input_message_content, encode_input_message_content)),
  ])
}

pub fn encode_inline_query_result_document(inline_query_result_document: InlineQueryResultDocument) -> Json {
json_object_filter_nulls([
...
#("caption", json.nullable(inline_query_result_document.caption, json.string)),
#("parse_mode", json.nullable(inline_query_result_document.parse_mode, json.string)),
#("caption_entities", json.nullable(inline_query_result_document.caption_entities, json.array(_, encode_message_entity))),
...
#("description", json.nullable(inline_query_result_document.description, json.string)),
#("reply_markup", json.nullable(inline_query_result_document.reply_markup, encode_inline_keyboard_markup)),
#("input_message_content", json.nullable(inline_query_result_document.input_message_content, encode_input_message_content)),
#("thumbnail_url", json.nullable(inline_query_result_document.thumbnail_url, json.string)),
#("thumbnail_width", json.nullable(inline_query_result_document.thumbnail_width, json.int)),
#("thumbnail_height", json.nullable(inline_query_result_document.thumbnail_height, json.int)),
  ])
}

pub fn encode_inline_query_result_location(inline_query_result_location: InlineQueryResultLocation) -> Json {
json_object_filter_nulls([
...
#("horizontal_accuracy", json.nullable(inline_query_result_location.horizontal_accuracy, json.float)),
#("live_period", json.nullable(inline_query_result_location.live_period, json.int)),
#("heading", json.nullable(inline_query_result_location.heading, json.int)),
#("proximity_alert_radius", json.nullable(inline_query_result_location.proximity_alert_radius, json.int)),
#("reply_markup", json.nullable(inline_query_result_location.reply_markup, encode_inline_keyboard_markup)),
#("input_message_content", json.nullable(inline_query_result_location.input_message_content, encode_input_message_content)),
#("thumbnail_url", json.nullable(inline_query_result_location.thumbnail_url, json.string)),
#("thumbnail_width", json.nullable(inline_query_result_location.thumbnail_width, json.int)),
#("thumbnail_height", json.nullable(inline_query_result_location.thumbnail_height, json.int)),
  ])
}

pub fn encode_inline_query_result_venue(inline_query_result_venue: InlineQueryResultVenue) -> Json {
json_object_filter_nulls([
...
#("foursquare_id", json.nullable(inline_query_result_venue.foursquare_id, json.string)),
#("foursquare_type", json.nullable(inline_query_result_venue.foursquare_type, json.string)),
#("google_place_id", json.nullable(inline_query_result_venue.google_place_id, json.string)),
#("google_place_type", json.nullable(inline_query_result_venue.google_place_type, json.string)),
#("reply_markup", json.nullable(inline_query_result_venue.reply_markup, encode_inline_keyboard_markup)),
#("input_message_content", json.nullable(inline_query_result_venue.input_message_content, encode_input_message_content)),
#("thumbnail_url", json.nullable(inline_query_result_venue.thumbnail_url, json.string)),
#("thumbnail_width", json.nullable(inline_query_result_venue.thumbnail_width, json.int)),
#("thumbnail_height", json.nullable(inline_query_result_venue.thumbnail_height, json.int)),
  ])
}

pub fn encode_inline_query_result_contact(inline_query_result_contact: InlineQueryResultContact) -> Json {
json_object_filter_nulls([
...
#("last_name", json.nullable(inline_query_result_contact.last_name, json.string)),
#("vcard", json.nullable(inline_query_result_contact.vcard, json.string)),
#("reply_markup", json.nullable(inline_query_result_contact.reply_markup, encode_inline_keyboard_markup)),
#("input_message_content", json.nullable(inline_query_result_contact.input_message_content, encode_input_message_content)),
#("thumbnail_url", json.nullable(inline_query_result_contact.thumbnail_url, json.string)),
#("thumbnail_width", json.nullable(inline_query_result_contact.thumbnail_width, json.int)),
#("thumbnail_height", json.nullable(inline_query_result_contact.thumbnail_height, json.int)),
  ])
}

pub fn encode_inline_query_result_game(inline_query_result_game: InlineQueryResultGame) -> Json {
json_object_filter_nulls([
...
#("reply_markup", json.nullable(inline_query_result_game.reply_markup, encode_inline_keyboard_markup)),
  ])
}

pub fn encode_inline_query_result_cached_photo(inline_query_result_cached_photo: InlineQueryResultCachedPhoto) -> Json {
json_object_filter_nulls([
#("type", json.string(inline_query_result_cached_photo.type_)),
#("id", json.string(inline_query_result_cached_photo.id)),
#("photo_file_id", json.string(inline_query_result_cached_photo.photo_file_id)),
#("title", json.nullable(inline_query_result_cached_photo.title, json.string)),
#("description", json.nullable(inline_query_result_cached_photo.description, json.string)),
#("caption", json.nullable(inline_query_result_cached_photo.caption, json.string)),
#("parse_mode", json.nullable(inline_query_result_cached_photo.parse_mode, json.string)),
#("caption_entities", json.nullable(inline_query_result_cached_photo.caption_entities, json.array(_, encode_message_entity))),
#("show_caption_above_media", json.nullable(inline_query_result_cached_photo.show_caption_above_media, json.bool)),
#("reply_markup", json.nullable(inline_query_result_cached_photo.reply_markup, encode_inline_keyboard_markup)),
#("input_message_content", json.nullable(inline_query_result_cached_photo.input_message_content, encode_input_message_content)),
  ])
}

pub fn encode_inline_query_result_cached_gif(inline_query_result_cached_gif: InlineQueryResultCachedGif) -> Json {
json_object_filter_nulls([
...
#("caption", json.nullable(inline_query_result_cached_gif.caption, json.string)),
#("parse_mode", json.nullable(inline_query_result_cached_gif.parse_mode, json.string)),
#("caption_entities", json.nullable(inline_query_result_cached_gif.caption_entities, json.array(_, encode_message_entity))),
#("show_caption_above_media", json.nullable(inline_query_result_cached_gif.show_caption_above_media, json.bool)),
#("reply_markup", json.nullable(inline_query_result_cached_gif.reply_markup, encode_inline_keyboard_markup)),
#("input_message_content", json.nullable(inline_query_result_cached_gif.input_message_content, encode_input_message_content)),
  ])
}

pub fn encode_inline_query_result_cached_mpeg4_gif(inline_query_result_cached_mpeg4_gif: InlineQueryResultCachedMpeg4Gif) -> Json {
json_object_filter_nulls([
#("type", json.string(inline_query_result_cached_mpeg4_gif.type_)),
#("id", json.string(inline_query_result_cached_mpeg4_gif.id)),
#("mpeg4_file_id", json.string(inline_query_result_cached_mpeg4_gif.mpeg4_file_id)),
#("title", json.nullable(inline_query_result_cached_mpeg4_gif.title, json.string)),
#("caption", json.nullable(inline_query_result_cached_mpeg4_gif.caption, json.string)),
#("parse_mode", json.nullable(inline_query_result_cached_mpeg4_gif.parse_mode, json.string)),
#("caption_entities", json.nullable(inline_query_result_cached_mpeg4_gif.caption_entities, json.array(_, encode_message_entity))),
#("show_caption_above_media", json.nullable(inline_query_result_cached_mpeg4_gif.show_caption_above_media, json.bool)),
#("reply_markup", json.nullable(inline_query_result_cached_mpeg4_gif.reply_markup, encode_inline_keyboard_markup)),
#("input_message_content", json.nullable(inline_query_result_cached_mpeg4_gif.input_message_content, encode_input_message_content)),
  ])
}

pub fn encode_inline_query_result_cached_sticker(inline_query_result_cached_sticker: InlineQueryResultCachedSticker) -> Json {
json_object_filter_nulls([
#("type", json.string(inline_query_result_cached_sticker.type_)),
#("id", json.string(inline_query_result_cached_sticker.id)),
#("sticker_file_id", json.string(inline_query_result_cached_sticker.sticker_file_id)),
#("reply_markup", json.nullable(inline_query_result_cached_sticker.reply_markup, encode_inline_keyboard_markup)),
#("input_message_content", json.nullable(inline_query_result_cached_sticker.input_message_content, encode_input_message_content)),
  ])
}

pub fn encode_inline_query_result_cached_document(inline_query_result_cached_document: InlineQueryResultCachedDocument) -> Json {
json_object_filter_nulls([
...
#("document_file_id", json.string(inline_query_result_cached_document.document_file_id)),
#("description", json.nullable(inline_query_result_cached_document.description, json.string)),
#("caption", json.nullable(inline_query_result_cached_document.caption, json.string)),
#("parse_mode", json.nullable(inline_query_result_cached_document.parse_mode, json.string)),
#("caption_entities", json.nullable(inline_query_result_cached_document.caption_entities, json.array(_, encode_message_entity))),
#("reply_markup", json.nullable(inline_query_result_cached_document.reply_markup, encode_inline_keyboard_markup)),
#("input_message_content", json.nullable(inline_query_result_cached_document.input_message_content, encode_input_message_content)),
  ])
}

pub fn encode_inline_query_result_cached_video(inline_query_result_cached_video: InlineQueryResultCachedVideo) -> Json {
json_object_filter_nulls([
#("type", json.string(inline_query_result_cached_video.type_)),
#("id", json.string(inline_query_result_cached_video.id)),
#("video_file_id", json.string(inline_query_result_cached_video.video_file_id)),
#("title", json.string(inline_query_result_cached_video.title)),
#("description", json.nullable(inline_query_result_cached_video.description, json.string)),
#("caption", json.nullable(inline_query_result_cached_video.caption, json.string)),
#("parse_mode", json.nullable(inline_query_result_cached_video.parse_mode, json.string)),
#("caption_entities", json.nullable(inline_query_result_cached_video.caption_entities, json.array(_, encode_message_entity))),
#("show_caption_above_media", json.nullable(inline_query_result_cached_video.show_caption_above_media, json.bool)),
#("reply_markup", json.nullable(inline_query_result_cached_video.reply_markup, encode_inline_keyboard_markup)),
#("input_message_content", json.nullable(inline_query_result_cached_video.input_message_content, encode_input_message_content)),
  ])
}

pub fn encode_inline_query_result_cached_voice(inline_query_result_cached_voice: InlineQueryResultCachedVoice) -> Json {
json_object_filter_nulls([
#("type", json.string(inline_query_result_cached_voice.type_)),
#("id", json.string(inline_query_result_cached_voice.id)),
#("voice_file_id", json.string(inline_query_result_cached_voice.voice_file_id)),
#("title", json.string(inline_query_result_cached_voice.title)),
#("caption", json.nullable(inline_query_result_cached_voice.caption, json.string)),
#("parse_mode", json.nullable(inline_query_result_cached_voice.parse_mode, json.string)),
#("caption_entities", json.nullable(inline_query_result_cached_voice.caption_entities, json.array(_, encode_message_entity))),
#("reply_markup", json.nullable(inline_query_result_cached_voice.reply_markup, encode_inline_keyboard_markup)),
#("input_message_content", json.nullable(inline_query_result_cached_voice.input_message_content, encode_input_message_content)),
  ])
}

pub fn encode_inline_query_result_cached_audio(inline_query_result_cached_audio: InlineQueryResultCachedAudio) -> Json {
json_object_filter_nulls([
#("type", json.string(inline_query_result_cached_audio.type_)),
#("id", json.string(inline_query_result_cached_audio.id)),
#("audio_file_id", json.string(inline_query_result_cached_audio.audio_file_id)),
#("caption", json.nullable(inline_query_result_cached_audio.caption, json.string)),
#("parse_mode", json.nullable(inline_query_result_cached_audio.parse_mode, json.string)),
#("caption_entities", json.nullable(inline_query_result_cached_audio.caption_entities, json.array(_, encode_message_entity))),
#("reply_markup", json.nullable(inline_query_result_cached_audio.reply_markup, encode_inline_keyboard_markup)),
#("input_message_content", json.nullable(inline_query_result_cached_audio.input_message_content, encode_input_message_content)),
  ])
}

pub fn encode_input_text_message_content(input_text_message_content: InputTextMessageContent) -> Json {
json_object_filter_nulls([
#("message_text", json.string(input_text_message_content.message_text)),
#("parse_mode", json.nullable(input_text_message_content.parse_mode, json.string)),
#("entities", json.nullable(input_text_message_content.entities, json.array(_, encode_message_entity))),
#("link_preview_options", json.nullable(input_text_message_content.link_preview_options, encode_link_preview_options)),
  ])
}

pub fn encode_input_location_message_content(input_location_message_content: InputLocationMessageContent) -> Json {
json_object_filter_nulls([
#("latitude", json.float(input_location_message_content.latitude)),
#("longitude", json.float(input_location_message_content.longitude)),
#("horizontal_accuracy", json.nullable(input_location_message_content.horizontal_accuracy, json.float)),
#("live_period", json.nullable(input_location_message_content.live_period, json.int)),
#("heading", json.nullable(input_location_message_content.heading, json.int)),
#("proximity_alert_radius", json.nullable(input_location_message_content.proximity_alert_radius, json.int)),
  ])
}

pub fn encode_input_venue_message_content(input_venue_message_content: InputVenueMessageContent) -> Json {
json_object_filter_nulls([
...
#("foursquare_id", json.nullable(input_venue_message_content.foursquare_id, json.string)),
#("foursquare_type", json.nullable(input_venue_message_content.foursquare_type, json.string)),
#("google_place_id", json.nullable(input_venue_message_content.google_place_id, json.string)),
#("google_place_type", json.nullable(input_venue_message_content.google_place_type, json.string)),
  ])
}

pub fn encode_input_contact_message_content(input_contact_message_content: InputContactMessageContent) -> Json {
json_object_filter_nulls([
...
#("last_name", json.nullable(input_contact_message_content.last_name, json.string)),
#("vcard", json.nullable(input_contact_message_content.vcard, json.string)),
  ])
}

pub fn encode_input_invoice_message_content(input_invoice_message_content: InputInvoiceMessageContent) -> Json {
json_object_filter_nulls([
...
#("provider_token", json.nullable(input_invoice_message_content.provider_token, json.string)),
#("currency", json.string(input_invoice_message_content.currency)),
#("prices", json.array(_, encode_labeled_price)(input_invoice_message_content.prices)),
#("max_tip_amount", json.nullable(input_invoice_message_content.max_tip_amount, json.int)),
#("suggested_tip_amounts", json.nullable(input_invoice_message_content.suggested_tip_amounts, json.array(_, json.int))),
#("provider_data", json.nullable(input_invoice_message_content.provider_data, json.string)),
#("photo_url", json.nullable(input_invoice_message_content.photo_url, json.string)),
#("photo_size", json.nullable(input_invoice_message_content.photo_size, json.int)),
#("photo_width", json.nullable(input_invoice_message_content.photo_width, json.int)),
#("photo_height", json.nullable(input_invoice_message_content.photo_height, json.int)),
#("need_name", json.nullable(input_invoice_message_content.need_name, json.bool)),
#("need_phone_number", json.nullable(input_invoice_message_content.need_phone_number, json.bool)),
#("need_email", json.nullable(input_invoice_message_content.need_email, json.bool)),
#("need_shipping_address", json.nullable(input_invoice_message_content.need_shipping_address, json.bool)),
#("send_phone_number_to_provider", json.nullable(input_invoice_message_content.send_phone_number_to_provider, json.bool)),
#("send_email_to_provider", json.nullable(input_invoice_message_content.send_email_to_provider, json.bool)),
#("is_flexible", json.nullable(input_invoice_message_content.is_flexible, json.bool)),
  ])
}

pub fn encode_chosen_inline_result(chosen_inline_result: ChosenInlineResult) -> Json {
json_object_filter_nulls([
...
#("inline_message_id", json.nullable(chosen_inline_result.inline_message_id, json.string)),
...
#("shipping_address", json.nullable(order_info.shipping_address, encode_shipping_address)),
  ])
}
...
#("subscription_expiration_date", json.nullable(successful_payment.subscription_expiration_date, json.int)),
#("is_recurring", json.nullable(successful_payment.is_recurring, json.bool)),
#("is_first_recurring", json.nullable(successful_payment.is_first_recurring, json.bool)),
#("shipping_option_id", json.nullable(successful_payment.shipping_option_id, json.string)),
#("order_info", json.nullable(successful_payment.order_info, encode_order_info)),
#("telegram_payment_charge_id", json.string(successful_payment.telegram_payment_charge_id)),
#("provider_payment_charge_id", json.string(successful_payment.provider_payment_charge_id)),
  ])
}
...
#("telegram_payment_charge_id", json.string(refunded_payment.telegram_payment_charge_id)),
#("provider_payment_charge_id", json.nullable(refunded_payment.provider_payment_charge_id, json.string)),
  ])
}
...
#("shipping_address", encode_shipping_address(shipping_query.shipping_address)),
  ])
}
...
#("shipping_option_id", json.nullable(pre_checkout_query.shipping_option_id, json.string)),
#("order_info", json.nullable(pre_checkout_query.order_info, encode_order_info)),
  ])
}

pub fn encode_paid_media_purchased(paid_media_purchased: PaidMediaPurchased) -> Json {
json_object_filter_nulls([
#("from", encode_user(paid_media_purchased.from)),
#("paid_media_payload", json.string(paid_media_purchased.paid_media_payload)),
  ])
}

pub fn encode_revenue_withdrawal_state_pending(revenue_withdrawal_state_pending: RevenueWithdrawalStatePending) -> Json {
json_object_filter_nulls([
#("type", json.string(revenue_withdrawal_state_pending.type_)),
  ])
}

pub fn encode_revenue_withdrawal_state_succeeded(revenue_withdrawal_state_succeeded: RevenueWithdrawalStateSucceeded) -> Json {
json_object_filter_nulls([
...
pub fn encode_revenue_withdrawal_state_failed(revenue_withdrawal_state_failed: RevenueWithdrawalStateFailed) -> Json {
json_object_filter_nulls([
...
json_object_filter_nulls([
#("affiliate_user", json.nullable(affiliate_info.affiliate_user, encode_user)),
#("affiliate_chat", json.nullable(affiliate_info.affiliate_chat, encode_chat)),
#("commission_per_mille", json.int(affiliate_info.commission_per_mille)),
#("amount", json.int(affiliate_info.amount)),
#("nanostar_amount", json.nullable(affiliate_info.nanostar_amount, json.int)),
  ])
}

pub fn encode_transaction_partner_user(transaction_partner_user: TransactionPartnerUser) -> Json {
json_object_filter_nulls([
#("type", json.string(transaction_partner_user.type_)),
#("transaction_type", json.string(transaction_partner_user.transaction_type)),
#("user", encode_user(transaction_partner_user.user)),
#("affiliate", json.nullable(transaction_partner_user.affiliate, encode_affiliate_info)),
#("invoice_payload", json.nullable(transaction_partner_user.invoice_payload, json.string)),
#("subscription_period", json.nullable(transaction_partner_user.subscription_period, json.int)),
#("paid_media", json.nullable(transaction_partner_user.paid_media, json.array(_, encode_paid_media))),
#("paid_media_payload", json.nullable(transaction_partner_user.paid_media_payload, json.string)),
#("gift", json.nullable(transaction_partner_user.gift, encode_gift)),
#("premium_subscription_duration", json.nullable(transaction_partner_user.premium_subscription_duration, json.int)),
  ])
}

pub fn encode_transaction_partner_chat(transaction_partner_chat: TransactionPartnerChat) -> Json {
json_object_filter_nulls([
...
pub fn encode_transaction_partner_affiliate_program(transaction_partner_affiliate_program: TransactionPartnerAffiliateProgram) -> Json {
json_object_filter_nulls([
#("type", json.string(transaction_partner_affiliate_program.type_)),
#("sponsor_user", json.nullable(transaction_partner_affiliate_program.sponsor_user, encode_user)),
#("commission_per_mille", json.int(transaction_partner_affiliate_program.commission_per_mille)),
  ])
}

pub fn encode_transaction_partner_fragment(transaction_partner_fragment: TransactionPartnerFragment) -> Json {
json_object_filter_nulls([
#("type", json.string(transaction_partner_fragment.type_)),
#("withdrawal_state", json.nullable(transaction_partner_fragment.withdrawal_state, encode_revenue_withdrawal_state)),
  ])
}

pub fn encode_transaction_partner_telegram_ads(transaction_partner_telegram_ads: TransactionPartnerTelegramAds) -> Json {
json_object_filter_nulls([
#("type", json.string(transaction_partner_telegram_ads.type_)),
  ])
}

pub fn encode_transaction_partner_telegram_api(transaction_partner_telegram_api: TransactionPartnerTelegramApi) -> Json {
json_object_filter_nulls([
...
pub fn encode_transaction_partner_other(transaction_partner_other: TransactionPartnerOther) -> Json {
json_object_filter_nulls([
...
#("nanostar_amount", json.nullable(star_transaction.nanostar_amount, json.int)),
#("date", json.int(star_transaction.date)),
#("source", json.nullable(star_transaction.source, encode_transaction_partner)),
#("receiver", json.nullable(star_transaction.receiver, encode_transaction_partner)),
  ])
}

pub fn encode_star_transactions(star_transactions: StarTransactions) -> Json {
json_object_filter_nulls([
#("transactions", json.array(_, encode_star_transaction)(star_transactions.transactions)),
  ])
}

pub fn encode_passport_data(passport_data: PassportData) -> Json {
json_object_filter_nulls([
#("data", json.array(_, encode_encrypted_passport_element)(passport_data.data)),
...
pub fn encode_encrypted_passport_element(encrypted_passport_element: EncryptedPassportElement) -> Json {
json_object_filter_nulls([
#("type", json.string(encrypted_passport_element.type_)),
#("data", json.nullable(encrypted_passport_element.data, json.string)),
#("phone_number", json.nullable(encrypted_passport_element.phone_number, json.string)),
#("email", json.nullable(encrypted_passport_element.email, json.string)),
#("files", json.nullable(encrypted_passport_element.files, json.array(_, encode_passport_file))),
#("front_side", json.nullable(encrypted_passport_element.front_side, encode_passport_file)),
#("reverse_side", json.nullable(encrypted_passport_element.reverse_side, encode_passport_file)),
#("selfie", json.nullable(encrypted_passport_element.selfie, encode_passport_file)),
#("translation", json.nullable(encrypted_passport_element.translation, json.array(_, encode_passport_file))),
#("hash", json.string(encrypted_passport_element.hash)),
  ])
}

pub fn encode_encrypted_credentials(encrypted_credentials: EncryptedCredentials) -> Json {
json_object_filter_nulls([
...
pub fn encode_passport_element_error_data_field(passport_element_error_data_field: PassportElementErrorDataField) -> Json {
json_object_filter_nulls([
...
pub fn encode_passport_element_error_front_side(passport_element_error_front_side: PassportElementErrorFrontSide) -> Json {
json_object_filter_nulls([
...
pub fn encode_passport_element_error_reverse_side(passport_element_error_reverse_side: PassportElementErrorReverseSide) -> Json {
json_object_filter_nulls([
...
pub fn encode_passport_element_error_selfie(passport_element_error_selfie: PassportElementErrorSelfie) -> Json {
json_object_filter_nulls([
...
pub fn encode_passport_element_error_file(passport_element_error_file: PassportElementErrorFile) -> Json {
json_object_filter_nulls([
...
pub fn encode_passport_element_error_files(passport_element_error_files: PassportElementErrorFiles) -> Json {
json_object_filter_nulls([
#("source", json.string(passport_element_error_files.source)),
#("type", json.string(passport_element_error_files.type_)),
#("file_hashes", json.array(_, json.string)(passport_element_error_files.file_hashes)),
#("message", json.string(passport_element_error_files.message)),
  ])
}

pub fn encode_passport_element_error_translation_file(passport_element_error_translation_file: PassportElementErrorTranslationFile) -> Json {
json_object_filter_nulls([
...
#("file_hash", json.string(passport_element_error_translation_file.file_hash)),
#("message", json.string(passport_element_error_translation_file.message)),
  ])
}

pub fn encode_passport_element_error_translation_files(passport_element_error_translation_files: PassportElementErrorTranslationFiles) -> Json {
json_object_filter_nulls([
...
#("file_hashes", json.array(_, json.string)(passport_element_error_translation_files.file_hashes)),
#("message", json.string(passport_element_error_translation_files.message)),
  ])
}

pub fn encode_passport_element_error_unspecified(passport_element_error_unspecified: PassportElementErrorUnspecified) -> Json {
json_object_filter_nulls([
#("source", json.string(passport_element_error_unspecified.source)),
#("type", json.string(passport_element_error_unspecified.type_)),
#("element_hash", json.string(passport_element_error_unspecified.element_hash)),
...
#("text_entities", json.nullable(game.text_entities, json.array(_, encode_message_entity))),
...
#("disable_edit_message", json.nullable(callback_game.disable_edit_message, json.bool)),
#("chat_id", json.nullable(callback_game.chat_id, json.int)),
#("message_id", json.nullable(callback_game.message_id, json.int)),
#("inline_message_id", json.nullable(callback_game.inline_message_id, json.string)),
  ])
}
...
pub fn maybe_inaccessible_message_decoder() -> decode.Decoder(MaybeInaccessibleMessage) {
...
use value <- decode.then(bot_command_scope_all_chat_administrators_decoder())
...
pub fn revenue_withdrawal_state_decoder() -> decode.Decoder(RevenueWithdrawalState) {
  use variant <- decode.field("type", decode.string)
  case variant {
...
decode.success(RevenueWithdrawalStateSucceededRevenueWithdrawalState(value))
}
...
use value <- decode.then(passport_element_error_translation_file_decoder())
decode.success(PassportElementErrorTranslationFilePassportElementError(value))
}
"passport_element_error_translation_files" -> {
use value <- decode.then(passport_element_error_translation_files_decoder())
decode.success(PassportElementErrorTranslationFilesPassportElementError(value))
}
...
pub fn encode_maybe_inaccessible_message(value: MaybeInaccessibleMessage) -> Json {
  case value {
MessageMaybeInaccessibleMessage(inner_value) -> encode_message(inner_value)

InaccessibleMessageMaybeInaccessibleMessage(inner_value) -> encode_inaccessible_message(inner_value)
...
pub fn encode_message_origin(value: MessageOrigin) -> Json {
  case value {
MessageOriginUserMessageOrigin(inner_value) -> encode_message_origin_user(inner_value)

MessageOriginHiddenUserMessageOrigin(inner_value) -> encode_message_origin_hidden_user(inner_value)

MessageOriginChatMessageOrigin(inner_value) -> encode_message_origin_chat(inner_value)

MessageOriginChannelMessageOrigin(inner_value) -> encode_message_origin_channel(inner_value)
...
pub fn encode_background_fill(value: BackgroundFill) -> Json {
  case value {
BackgroundFillSolidBackgroundFill(inner_value) -> encode_background_fill_solid(inner_value)

BackgroundFillGradientBackgroundFill(inner_value) -> encode_background_fill_gradient(inner_value)

BackgroundFillFreeformGradientBackgroundFill(inner_value) -> encode_background_fill_freeform_gradient(inner_value)
...
pub fn encode_background_type(value: BackgroundType) -> Json {
  case value {
BackgroundTypeFillBackgroundType(inner_value) -> encode_background_type_fill(inner_value)

BackgroundTypeWallpaperBackgroundType(inner_value) -> encode_background_type_wallpaper(inner_value)

BackgroundTypePatternBackgroundType(inner_value) -> encode_background_type_pattern(inner_value)

BackgroundTypeChatThemeBackgroundType(inner_value) -> encode_background_type_chat_theme(inner_value)
...
pub fn encode_chat_member(value: ChatMember) -> Json {
  case value {
ChatMemberOwnerChatMember(inner_value) -> encode_chat_member_owner(inner_value)

ChatMemberAdministratorChatMember(inner_value) -> encode_chat_member_administrator(inner_value)

ChatMemberMemberChatMember(inner_value) -> encode_chat_member_member(inner_value)

ChatMemberRestrictedChatMember(inner_value) -> encode_chat_member_restricted(inner_value)

ChatMemberLeftChatMember(inner_value) -> encode_chat_member_left(inner_value)

ChatMemberBannedChatMember(inner_value) -> encode_chat_member_banned(inner_value)
...
pub fn encode_reaction_type(value: ReactionType) -> Json {
  case value {
ReactionTypeEmojiReactionType(inner_value) -> encode_reaction_type_emoji(inner_value)

ReactionTypeCustomEmojiReactionType(inner_value) -> encode_reaction_type_custom_emoji(inner_value)

ReactionTypePaidReactionType(inner_value) -> encode_reaction_type_paid(inner_value)
...
pub fn encode_bot_command_scope(value: BotCommandScope) -> Json {
  case value {
BotCommandScopeDefaultBotCommandScope(inner_value) -> encode_bot_command_scope_default(inner_value)

BotCommandScopeAllPrivateChatsBotCommandScope(inner_value) -> encode_bot_command_scope_all_private_chats(inner_value)

BotCommandScopeAllGroupChatsBotCommandScope(inner_value) -> encode_bot_command_scope_all_group_chats(inner_value)

BotCommandScopeAllChatAdministratorsBotCommandScope(inner_value) -> encode_bot_command_scope_all_chat_administrators(inner_value)

BotCommandScopeChatBotCommandScope(inner_value) -> encode_bot_command_scope_chat(inner_value)

BotCommandScopeChatAdministratorsBotCommandScope(inner_value) -> encode_bot_command_scope_chat_administrators(inner_value)

BotCommandScopeChatMemberBotCommandScope(inner_value) -> encode_bot_command_scope_chat_member(inner_value)
...
pub fn encode_menu_button(value: MenuButton) -> Json {
  case value {
MenuButtonCommandsMenuButton(inner_value) -> encode_menu_button_commands(inner_value)

MenuButtonWebAppMenuButton(inner_value) -> encode_menu_button_web_app(inner_value)

MenuButtonDefaultMenuButton(inner_value) -> encode_menu_button_default(inner_value)
...
pub fn encode_chat_boost_source(value: ChatBoostSource) -> Json {
  case value {
ChatBoostSourcePremiumChatBoostSource(inner_value) -> encode_chat_boost_source_premium(inner_value)

ChatBoostSourceGiftCodeChatBoostSource(inner_value) -> encode_chat_boost_source_gift_code(inner_value)

ChatBoostSourceGiveawayChatBoostSource(inner_value) -> encode_chat_boost_source_giveaway(inner_value)
...
InputMediaVideoInputMedia(inner_value) -> encode_input_media_video(inner_value)
...
pub fn encode_input_profile_photo(value: InputProfilePhoto) -> Json {
  case value {
InputProfilePhotoStaticInputProfilePhoto(inner_value) -> encode_input_profile_photo_static(inner_value)

InputProfilePhotoAnimatedInputProfilePhoto(inner_value) -> encode_input_profile_photo_animated(inner_value)
...
pub fn encode_inline_query_result(value: InlineQueryResult) -> Json {
  case value {
InlineQueryResultCachedAudioInlineQueryResult(inner_value) -> encode_inline_query_result_cached_audio(inner_value)

InlineQueryResultCachedDocumentInlineQueryResult(inner_value) -> encode_inline_query_result_cached_document(inner_value)

InlineQueryResultCachedGifInlineQueryResult(inner_value) -> encode_inline_query_result_cached_gif(inner_value)

InlineQueryResultCachedMpeg4GifInlineQueryResult(inner_value) -> encode_inline_query_result_cached_mpeg4_gif(inner_value)

InlineQueryResultCachedPhotoInlineQueryResult(inner_value) -> encode_inline_query_result_cached_photo(inner_value)

InlineQueryResultCachedStickerInlineQueryResult(inner_value) -> encode_inline_query_result_cached_sticker(inner_value)

InlineQueryResultCachedVideoInlineQueryResult(inner_value) -> encode_inline_query_result_cached_video(inner_value)

InlineQueryResultCachedVoiceInlineQueryResult(inner_value) -> encode_inline_query_result_cached_voice(inner_value)

InlineQueryResultArticleInlineQueryResult(inner_value) -> encode_inline_query_result_article(inner_value)

InlineQueryResultAudioInlineQueryResult(inner_value) -> encode_inline_query_result_audio(inner_value)

InlineQueryResultContactInlineQueryResult(inner_value) -> encode_inline_query_result_contact(inner_value)

InlineQueryResultGameInlineQueryResult(inner_value) -> encode_inline_query_result_game(inner_value)

InlineQueryResultDocumentInlineQueryResult(inner_value) -> encode_inline_query_result_document(inner_value)

InlineQueryResultGifInlineQueryResult(inner_value) -> encode_inline_query_result_gif(inner_value)

InlineQueryResultLocationInlineQueryResult(inner_value) -> encode_inline_query_result_location(inner_value)

InlineQueryResultMpeg4GifInlineQueryResult(inner_value) -> encode_inline_query_result_mpeg4_gif(inner_value)

InlineQueryResultPhotoInlineQueryResult(inner_value) -> encode_inline_query_result_photo(inner_value)

InlineQueryResultVenueInlineQueryResult(inner_value) -> encode_inline_query_result_venue(inner_value)

InlineQueryResultVideoInlineQueryResult(inner_value) -> encode_inline_query_result_video(inner_value)

InlineQueryResultVoiceInlineQueryResult(inner_value) -> encode_inline_query_result_voice(inner_value)
...
pub fn encode_input_message_content(value: InputMessageContent) -> Json {
  case value {
InputTextMessageContentInputMessageContent(inner_value) -> encode_input_text_message_content(inner_value)

InputLocationMessageContentInputMessageContent(inner_value) -> encode_input_location_message_content(inner_value)

InputVenueMessageContentInputMessageContent(inner_value) -> encode_input_venue_message_content(inner_value)

InputContactMessageContentInputMessageContent(inner_value) -> encode_input_contact_message_content(inner_value)

InputInvoiceMessageContentInputMessageContent(inner_value) -> encode_input_invoice_message_content(inner_value)
...
pub fn encode_revenue_withdrawal_state(value: RevenueWithdrawalState) -> Json {
  case value {
RevenueWithdrawalStatePendingRevenueWithdrawalState(inner_value) -> encode_revenue_withdrawal_state_pending(inner_value)

RevenueWithdrawalStateSucceededRevenueWithdrawalState(inner_value) -> encode_revenue_withdrawal_state_succeeded(inner_value)

RevenueWithdrawalStateFailedRevenueWithdrawalState(inner_value) -> encode_revenue_withdrawal_state_failed(inner_value)
...
pub fn encode_transaction_partner(value: TransactionPartner) -> Json {
  case value {
TransactionPartnerUserTransactionPartner(inner_value) -> encode_transaction_partner_user(inner_value)

TransactionPartnerChatTransactionPartner(inner_value) -> encode_transaction_partner_chat(inner_value)

TransactionPartnerAffiliateProgramTransactionPartner(inner_value) -> encode_transaction_partner_affiliate_program(inner_value)

TransactionPartnerFragmentTransactionPartner(inner_value) -> encode_transaction_partner_fragment(inner_value)

TransactionPartnerTelegramAdsTransactionPartner(inner_value) -> encode_transaction_partner_telegram_ads(inner_value)

TransactionPartnerTelegramApiTransactionPartner(inner_value) -> encode_transaction_partner_telegram_api(inner_value)

TransactionPartnerOtherTransactionPartner(inner_value) -> encode_transaction_partner_other(inner_value)
...
pub fn encode_passport_element_error(value: PassportElementError) -> Json {
  case value {
PassportElementErrorDataFieldPassportElementError(inner_value) -> encode_passport_element_error_data_field(inner_value)

PassportElementErrorFrontSidePassportElementError(inner_value) -> encode_passport_element_error_front_side(inner_value)

PassportElementErrorReverseSidePassportElementError(inner_value) -> encode_passport_element_error_reverse_side(inner_value)

PassportElementErrorSelfiePassportElementError(inner_value) -> encode_passport_element_error_selfie(inner_value)

PassportElementErrorFilePassportElementError(inner_value) -> encode_passport_element_error_file(inner_value)

PassportElementErrorFilesPassportElementError(inner_value) -> encode_passport_element_error_files(inner_value)

PassportElementErrorTranslationFilePassportElementError(inner_value) -> encode_passport_element_error_translation_file(inner_value)

PassportElementErrorTranslationFilesPassportElementError(inner_value) -> encode_passport_element_error_translation_files(inner_value)

PassportElementErrorUnspecifiedPassportElementError(inner_value) -> encode_passport_element_error_unspecified(inner_value)
